...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m1039constructorimpl = Result.m1039constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            m1039constructorimpl = Result.m1039constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.Companion;
            m1039constructorimpl = Result.m1039constructorimpl(ResultKt.createFailure(th3));
        }
        return Result.m1045isFailureimpl(m1039constructorimpl) ? null : m1039constructorimpl;
    }

    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m1039constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m1039constructorimpl = Result.m1039constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m1039constructorimpl = Result.m1039constructorimpl(ResultKt.createFailure(th));
        }
