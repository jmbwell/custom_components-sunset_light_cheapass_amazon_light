...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2651scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2571delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2572toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2572toDelayMillisLRDsOJo(long j) {
        boolean m2460isPositiveimpl = Duration.m2460isPositiveimpl(j);
        if (m2460isPositiveimpl) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m2444getInWholeMillisecondsimpl(Duration.m2462plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        } else if (m2460isPositiveimpl) {
