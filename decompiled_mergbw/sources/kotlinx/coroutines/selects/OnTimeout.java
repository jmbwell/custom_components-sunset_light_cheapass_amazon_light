...
final class OnTimeout {
    ...
    public final void register(final SelectInstance<?> selectInstance, Object obj) {
        ...
        selectImplementation.disposeOnCompletion(DelayKt.getDelay(context).invokeOnTimeout(this.timeMillis, new Runnable() { // from class: kotlinx.coroutines.selects.OnTimeout$register$$inlined$Runnable$1
