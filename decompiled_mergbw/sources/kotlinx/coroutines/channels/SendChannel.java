...
public interface SendChannel<E> {
    ...
    void mo2666invokeOnClose(Function1<? super Throwable, Unit> function1);
    ...
    Object mo2583trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2583trySendJP2dKIU = sendChannel.mo2583trySendJP2dKIU(e);
            if (ChannelResult.m2608isSuccessimpl(mo2583trySendJP2dKIU)) {
                return true;
            }
            Throwable m2602exceptionOrNullimpl = ChannelResult.m2602exceptionOrNullimpl(mo2583trySendJP2dKIU);
