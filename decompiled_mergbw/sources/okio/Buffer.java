...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m2871deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m2872deprecated_size() {
        return this.size;
    }
    ...
    */
                ...
                if (size() - j2 < j2) {
                    ...
                    if (segment != null) {
                        ...
                        while (j3 < size2) {
                            ...
                            while (i < min) {
                                if (bArr[i] == b2 && okio.internal.Buffer.rangeEquals(segment, i + 1, internalArray$okio, 1, size)) {
                                    return (i - segment.pos) + j3;
                                }
                                i++;
                            }
                    ...
                    if (segment != null) {
                        ...
                        while (j3 < size4) {
                            ...
                            i = (int) ((segment.pos + j2) - j3);
                            while (i < min2) {
                                if (bArr2[i] == b3 && okio.internal.Buffer.rangeEquals(segment, i + 1, internalArray$okio2, 1, size3)) {
                                    return (i - segment.pos) + j3;
                                }
                                i++;
                            }
    ...
    public final ByteString snapshot(int i) {
        ...
        return new C0049SegmentedByteString(bArr, iArr);
    }
}
