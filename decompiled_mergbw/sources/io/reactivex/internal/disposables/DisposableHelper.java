...
public enum DisposableHelper implements Disposable {
    ...
    public static boolean set(AtomicReference<Disposable> atomicReference, Disposable disposable) {
        ...
        } while (!AtomicReference$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, disposable2, disposable));
        if (disposable2 != null) {
            disposable2.dispose();
            return true;
        }
    ...
    public static boolean setOnce(AtomicReference<Disposable> atomicReference, Disposable disposable) {
        ...
        if (AtomicReference$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, null, disposable)) {
            return true;
        }
        disposable.dispose();
