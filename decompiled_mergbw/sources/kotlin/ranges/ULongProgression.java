...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m2257getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }

    /* renamed from: getFirst-s-VKNKU  reason: not valid java name */
    public final long m2328getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m2329getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m1217constructorimpl(j ^ ULong.m1217constructorimpl(j >>> 32))) * 31) + ((int) ULong.m1217constructorimpl(j2 ^ ULong.m1217constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m1263toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m1263toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m2330fromClosedRange7ftBX0g(long j, long j2, long j3) {
