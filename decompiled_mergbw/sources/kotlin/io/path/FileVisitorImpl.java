...
final class FileVisitorImpl extends SimpleFileVisitor<Path> {
    ...
    public /* bridge */ /* synthetic */ FileVisitResult postVisitDirectory(Object obj, IOException iOException) {
        return postVisitDirectory(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2276m(obj), iOException);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult preVisitDirectory(Object obj, BasicFileAttributes basicFileAttributes) {
        return preVisitDirectory(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2276m(obj), basicFileAttributes);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult visitFile(Object obj, BasicFileAttributes basicFileAttributes) {
        return visitFile(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2276m(obj), basicFileAttributes);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult visitFileFailed(Object obj, IOException iOException) {
        return visitFileFailed(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2276m(obj), iOException);
    }
    ...
    public FileVisitResult preVisitDirectory(Path dir, BasicFileAttributes attrs) {
        FileVisitResult m2272m;
        Intrinsics.checkNotNullParameter(dir, "dir");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Function2<Path, BasicFileAttributes, FileVisitResult> function2 = this.onPreVisitDirectory;
        if (function2 == null || (m2272m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2272m((Object) function2.invoke(dir, attrs))) == null) {
    ...
    public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) {
        ...
        if (function2 == null || (m2272m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2272m((Object) function2.invoke(file, attrs))) == null) {
    ...
    public FileVisitResult visitFileFailed(Path file, IOException exc) {
        ...
        if (function2 == null || (m2272m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2272m((Object) function2.invoke(file, exc))) == null) {
    ...
    public FileVisitResult postVisitDirectory(Path dir, IOException iOException) {
        ...
        if (function2 == null || (m2272m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2272m((Object) function2.invoke(dir, iOException))) == null) {
