...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m2427getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo2424minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2540minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo2423elapsedNowUwyO8pc() {
        return Duration.m2461minusLRDsOJo(this.mark.mo2423elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2426plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m2462plusLRDsOJo(this.adjustment, j), null);
    }
}
