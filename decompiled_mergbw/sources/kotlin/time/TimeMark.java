...
public interface TimeMark {
    ...
    TimeMark mo2424minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2426plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m2541plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m2540minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo2426plusLRDsOJo(Duration.m2477unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2459isNegativeimpl(timeMark.mo2423elapsedNowUwyO8pc());
        }
