...
public final class SerializeWriter extends Writer {
    ...
    public void writeByteArray(byte[] bArr) {
        ...
        if (i5 > this.buf.length) {
            if (this.writer != null) {
                ...
                while (i6 < i) {
                    ...
                    i6 += 3;
                    int i9 = i8 | ((bArr[i6] & 255) << 16) | (bArr[i7] & 255);
                    write(cArr[(i9 >>> 18) & 63]);
                    write(cArr[(i9 >>> 12) & 63]);
                    write(cArr[(i9 >>> 6) & 63]);
                    write(cArr[i9 & 63]);
        ...
        while (i13 < i) {
            int i14 = i13 + 2;
            int i15 = (bArr[i13 + 1] & 255) << 8;
            i13 += 3;
            int i16 = i15 | ((bArr[i13] & 255) << 16) | (bArr[i14] & 255);
            char[] cArr2 = this.buf;
    ...
    public void writeEnum(Enum<?> r2) {
        ...
        if (this.writeEnumUsingName && !this.writeEnumUsingToString) {
            ...
            str = this.writeEnumUsingToString ? r2.toString() : null;
        }
        if (str != null) {
    ...
    */
    ...
    public void writeFieldValue(char c2, String str, char c3) {
        ...
        writeFieldName(str);
        if (c3 == 0) {
            writeString(WebViewProviderFactoryBoundaryInterface.MULTI_COOKIE_VALUE_SEPARATOR);
        } else {
    ...
    public void writeFieldValue(char c2, String str, int i) {
        ...
        char[] cArr2 = this.buf;
        cArr2[i4 + 2] = this.keySeperator;
        cArr2[i4 + 3] = AbstractJsonLexerKt.COLON;
    ...
    public void writeFieldValue(char c2, String str, long j) {
        ...
        cArr2[i3 + 3] = AbstractJsonLexerKt.COLON;
    ...
    */
    ...
    public void writeFieldValueStringWithDoubleQuote(char c2, String str, String str2) {
        ...
        char[] cArr2 = this.buf;
        cArr2[i5] = '\"';
        cArr2[i5 + 1] = AbstractJsonLexerKt.COLON;
        cArr2[i5 + 2] = '\"';
