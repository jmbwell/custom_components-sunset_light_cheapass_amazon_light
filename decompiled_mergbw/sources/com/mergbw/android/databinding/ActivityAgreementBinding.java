...
public final class ActivityAgreementBinding implements ViewBinding {
    ...
    private ActivityAgreementBinding(LinearLayout linearLayout, ImageView imageView, TextView textView, WebView webView) {
    ...
    public static ActivityAgreementBinding bind(View view) {
        ...
        if (imageView != null) {
            ...
            if (textView != null) {
                ...
                if (webView != null) {
                    return new ActivityAgreementBinding((LinearLayout) view, imageView, textView, webView);
                }
            }
        }
