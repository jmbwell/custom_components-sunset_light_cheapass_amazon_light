                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        WaveProgressView waveProgressView = (WaveProgressView) ViewBindings.findChildViewById(view, i);
                                                        if (waveProgressView != null) {
                                                            return new ActivityDeviceUpgradeBinding((ConstraintLayout) view, button, button2, imageView, imageView2, linearLayout, relativeLayout, linearLayout2, constraintLayout, textView, textView2, textView3, textView4, waveProgressView);
                                                        }
                                                    }
                                                }
                                            }
