...
public final class ActivityGroupSettingBinding implements ViewBinding {
    ...
    private ActivityGroupSettingBinding(RelativeLayout relativeLayout, Button button, ImageView imageView, FrameLayout frameLayout, ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, ExpandableListView expandableListView, TextView textView, TextView textView2, TextView textView3) {
                            ...
                            if (expandableListView != null) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            return new ActivityGroupSettingBinding((RelativeLayout) view, button, imageView, frameLayout, constraintLayout, constraintLayout2, expandableListView, textView, textView2, textView3);
                                        }
                                    }
                                }
                            }
