...
public class UserinfoManage {
    ...
    public String getAvatar() {
        return mUserData.getString("avatar", null);
    }
    ...
    public long getLastAdShowTime() {
        return mUserData.getLong("LastAdShowTime", 0L);
    }
    ...
    public boolean isSetWhiteNoiseTimer() {
        return mUserData.getBoolean("SetWhiteNoiseTimer", false);
    }

    public void setWhiteNoiseTimer(boolean z) {
        mUserData.edit().putBoolean("SetWhiteNoiseTimer", z).apply();
    }

    public int getWhiteNoiseOffTimeHour() {
        return mUserData.getInt("WhiteNoiseOffTimeHour", 0);
    }

    public void setWhiteNoiseOffTimeHour(int i) {
        mUserData.edit().putInt("WhiteNoiseOffTimeHour", i).apply();
    }

    public int getWhiteNoiseOffTimeMin() {
        return mUserData.getInt("WhiteNoiseOffTimeMin", 0);
    }

    public void setWhiteNoiseOffTimeMin(int i) {
        mUserData.edit().putInt("WhiteNoiseOffTimeMin", i).apply();
    }
}
