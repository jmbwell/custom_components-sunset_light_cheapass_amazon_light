...
public abstract class BannerAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements IViewHolder<T, VH> {
        ...
        if (this.mOnBannerListener != null) {
            vh.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.youth.banner.adapter.BannerAdapter$$ExternalSyntheticLambda1
                ...
                public final void onClick(View view) {
                    BannerAdapter.this.m1033lambda$onBindViewHolder$0$comyouthbanneradapterBannerAdapter(t, realPosition, view);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m1033lambda$onBindViewHolder$0$comyouthbanneradapterBannerAdapter(Object obj, int i, View view) {
    ...
    public VH onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        vh.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.youth.banner.adapter.BannerAdapter$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BannerAdapter.this.m1034xaad9b058(vh, view);
            }
        });
        return vh;
    }
    ...
    public /* synthetic */ void m1034xaad9b058(RecyclerView.ViewHolder viewHolder, View view) {
        if (this.mOnBannerListener != null) {
