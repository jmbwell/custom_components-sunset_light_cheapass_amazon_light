...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    */
    ...
    public /* synthetic */ void m558xdf87d0bf() {
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (m647m = Timestamp$$ExternalSyntheticApiModelOutline0.m647m(getContext().getSystemService(Timestamp$$ExternalSyntheticApiModelOutline0.m650m()))) != null) {
                m647m.notifyValueChanged(this);
            }
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "MaterialCheckBox.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " CheckedState=" + getCheckedStateString() + VectorFormat.DEFAULT_SUFFIX;
        }
