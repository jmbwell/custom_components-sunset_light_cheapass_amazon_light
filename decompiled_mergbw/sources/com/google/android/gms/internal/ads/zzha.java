...
public final class zzha extends zzfs {
    ...
    public zzha(int i) {
        super(true);
        byte[] bArr = new byte[MicrosphereInterpolator.DEFAULT_MICROSPHERE_ELEMENTS];
        this.zza = bArr;
        this.zzb = new DatagramPacket(bArr, 0, (int) MicrosphereInterpolator.DEFAULT_MICROSPHERE_ELEMENTS);
    }
