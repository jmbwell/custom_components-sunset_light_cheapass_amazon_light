...
public abstract class zzhhz {
    ...
    public static zzhhr zzb(Class cls) {
        ...
        } else if (!cls.getPackage().equals(zzhhz.class.getPackage())) {
        ...
        try {
            try {
                try {
                    return (zzhhr) cls.cast(((zzhhz) Class.forName(format, true, classLoader).getConstructor(null).newInstance(null)).zza());
            ...
            while (it.hasNext()) {
                try {
                    ...
                    Logger logger = Logger.getLogger(zzhhm.class.getName());
