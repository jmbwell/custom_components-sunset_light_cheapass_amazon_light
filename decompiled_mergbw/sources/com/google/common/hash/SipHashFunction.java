...
final class SipHashFunction extends AbstractHashFunction implements Serializable {
    ...
    public Hasher newHasher() {
        return new SipHasher(this.f44c, this.d, this.k0, this.k1);
    }
    ...
    public boolean equals(@CheckForNull Object obj) {
        if (obj instanceof SipHashFunction) {
            ...
            return this.f44c == sipHashFunction.f44c && this.d == sipHashFunction.d && this.k0 == sipHashFunction.k0 && this.k1 == sipHashFunction.k1;
        }
        return false;
    }

    public int hashCode() {
        return (int) ((((getClass().hashCode() ^ this.f44c) ^ this.d) ^ this.k0) ^ this.k1);
    }
    ...
    private static final class SipHasher extends AbstractStreamingHasher {
        ...
        protected void processRemaining(ByteBuffer byteBuffer) {
            this.f45b += byteBuffer.remaining();
            int i = 0;
        ...
        protected HashCode makeHash() {
            long j = this.finalM ^ (this.f45b << 56);
            this.finalM = j;
            processM(j);
            this.v2 ^= 255;
            sipRound(this.d);
