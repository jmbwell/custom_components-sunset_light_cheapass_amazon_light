...
public final class ProcessDetails {
    ...
    public int hashCode() {
        return (((((this.processName.hashCode() * 31) + this.pid) * 31) + this.importance) * 31) + UByte$$ExternalSyntheticBackport0.m(this.isDefaultProcess);
    }
