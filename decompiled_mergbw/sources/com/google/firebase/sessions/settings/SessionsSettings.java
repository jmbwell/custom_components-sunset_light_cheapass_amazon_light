...
public final class SessionsSettings {
    ...
    public final long m731getSessionRestartTimeoutUwyO8pc() {
        Duration mo729getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo729getSessionRestartTimeoutFghU774();
        if (mo729getSessionRestartTimeoutFghU774 != null) {
            long m2479unboximpl = mo729getSessionRestartTimeoutFghU774.m2479unboximpl();
            if (m730isValidSessionRestartTimeoutLRDsOJo(m2479unboximpl)) {
                return m2479unboximpl;
            }
        }
        Duration mo729getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo729getSessionRestartTimeoutFghU774();
        if (mo729getSessionRestartTimeoutFghU7742 != null) {
            long m2479unboximpl2 = mo729getSessionRestartTimeoutFghU7742.m2479unboximpl();
            if (m730isValidSessionRestartTimeoutLRDsOJo(m2479unboximpl2)) {
                return m2479unboximpl2;
            }
        }
    ...
    private final boolean m730isValidSessionRestartTimeoutLRDsOJo(long j) {
        return Duration.m2460isPositiveimpl(j) && Duration.m2455isFiniteimpl(j);
    }
