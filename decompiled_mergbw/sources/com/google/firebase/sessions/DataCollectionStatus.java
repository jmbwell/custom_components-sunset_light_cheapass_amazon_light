...
public final class DataCollectionStatus {
    ...
    public int hashCode() {
        return (((this.performance.hashCode() * 31) + this.crashlytics.hashCode()) * 31) + UByte$$ExternalSyntheticBackport0.m(this.sessionSamplingRate);
    }
