...
final class AutoValue_InstallationTokenResult extends InstallationTokenResult {
    ...
    public String toString() {
        return "InstallationTokenResult{token=" + this.token + ", tokenExpirationTimestamp=" + this.tokenExpirationTimestamp + ", tokenCreationTimestamp=" + this.tokenCreationTimestamp + VectorFormat.DEFAULT_SUFFIX;
    }
