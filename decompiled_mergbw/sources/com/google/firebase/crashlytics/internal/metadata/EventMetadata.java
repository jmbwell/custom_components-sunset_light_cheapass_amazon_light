...
public final class EventMetadata {
    ...
    public int hashCode() {
        return (((this.sessionId.hashCode() * 31) + UByte$$ExternalSyntheticBackport0.m(this.timestamp)) * 31) + this.additionalCustomKeys.hashCode();
    }
