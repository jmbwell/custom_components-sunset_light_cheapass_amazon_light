...
final class AutoValue_RolloutAssignment extends RolloutAssignment {
    ...
    public String toString() {
        return "RolloutAssignment{rolloutId=" + this.rolloutId + ", variantId=" + this.variantId + ", parameterKey=" + this.parameterKey + ", parameterValue=" + this.parameterValue + ", templateVersion=" + this.templateVersion + VectorFormat.DEFAULT_SUFFIX;
    }
