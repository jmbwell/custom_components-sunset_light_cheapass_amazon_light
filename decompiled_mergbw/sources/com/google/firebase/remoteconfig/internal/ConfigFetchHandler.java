...
public class ConfigFetchHandler {
    ...
    public Task<FetchResponse> fetch(final long j) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigFetchHandler$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task) {
                return ConfigFetchHandler.this.m716x7459e696(j, hashMap, task);
            }
        });
    }
    ...
    public Task<FetchResponse> fetchNowWithTypeAndAttemptNumber(FetchType fetchType, int i) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigFetchHandler$$ExternalSyntheticLambda3
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
                return ConfigFetchHandler.this.m719xdbe8963a(hashMap, task);
            }
        });
    }
    ...
    public /* synthetic */ Task m719xdbe8963a(Map map, Task task) throws Exception {
        return m716x7459e696(task, 0L, map);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: fetchIfCacheExpiredAndNotThrottled */
    public Task<FetchResponse> m716x7459e696(Task<ConfigContainer> task, long j, final Map<String, String> map) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            continueWithTask = Tasks.whenAllComplete(id, token).continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigFetchHandler$$ExternalSyntheticLambda1
                ...
                public final Object then(Task task2) {
                    return ConfigFetchHandler.this.m717x5d615250(id, token, date, map, task2);
                }
            });
        }
        return continueWithTask.continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigFetchHandler$$ExternalSyntheticLambda2
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task2) {
                return ConfigFetchHandler.this.m718xf19fc1ef(date, task2);
            }
        });
    }
    ...
    public /* synthetic */ Task m717x5d615250(Task task, Task task2, Date date, Map map, Task task3) throws Exception {
    ...
    public /* synthetic */ Task m718xf19fc1ef(Date date, Task task) throws Exception {
