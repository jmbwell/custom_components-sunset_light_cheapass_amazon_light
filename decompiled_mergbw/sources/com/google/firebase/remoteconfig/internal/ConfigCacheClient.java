...
public class ConfigCacheClient {
    ...
    private static final Executor DIRECT_EXECUTOR = new AdIdManagerImplCommon$$ExternalSyntheticLambda4();
    ...
    public /* synthetic */ Void m714xddaae01c(ConfigContainer configContainer) throws Exception {
    ...
    public Task<ConfigContainer> put(final ConfigContainer configContainer, final boolean z) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.internal.ConfigCacheClient$$ExternalSyntheticLambda0
            ...
            public final Object call() {
                return ConfigCacheClient.this.m714xddaae01c(configContainer);
            }
            ...
            public final Task then(Object obj) {
                return ConfigCacheClient.this.m715x9820809d(z, configContainer, (Void) obj);
            }
        });
    }
    ...
    public /* synthetic */ Task m715x9820809d(boolean z, ConfigContainer configContainer, Void r3) throws Exception {
        if (z) {
