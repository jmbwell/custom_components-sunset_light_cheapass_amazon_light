...
public class MersenneTwister extends BitsStreamGenerator implements Serializable {
    ...
    public void setSeed(int i) {
        ...
        while (true) {
            ...
            int i3 = this.mti;
            if (i3 < N) {
                j = (((j ^ (j >> 30)) * 1812433253) + i3) & 4294967295L;
                this.mt[i3] = (int) j;
                i2 = i3 + 1;
            } else {
                clear();
    ...
    public void setSeed(int[] iArr) {
        ...
        int i = 1;
        int i2 = 0;
        for (int max = FastMath.max((int) N, iArr.length); max != 0; max--) {
            int[] iArr2 = this.mt;
            int i3 = iArr2[i];
            long j = (i3 & 2147483647L) | (i3 < 0 ? 2147483648L : 0L);
            int i4 = iArr2[i - 1];
            long j2 = (i4 & 2147483647L) | (i4 < 0 ? 2147483648L : 0L);
            iArr2[i] = (int) (((((j2 ^ (j2 >> 30)) * 1664525) ^ j) + iArr[i2] + i2) & 4294967295L);
            i++;
            i2++;
            if (i >= N) {
                iArr2[0] = iArr2[623];
        ...
        for (int i5 = 623; i5 != 0; i5--) {
            int[] iArr3 = this.mt;
            int i6 = iArr3[i];
            long j3 = (i6 < 0 ? 2147483648L : 0L) | (i6 & 2147483647L);
            int i7 = iArr3[i - 1];
            long j4 = (i7 & 2147483647L) | (i7 < 0 ? 2147483648L : 0L);
            iArr3[i] = (int) (((j3 ^ ((j4 ^ (j4 >> 30)) * 1566083941)) - i) & 4294967295L);
            i++;
            if (i >= N) {
                iArr3[0] = iArr3[623];
                i = 1;
