...
public class Vector3DFormat extends VectorFormat<Euclidean3D> {
    ...
    @Override // org.apache.commons.math3.geometry.VectorFormat
    public Vector<Euclidean3D> parse(String str) throws MathParseException {
        ParsePosition parsePosition = new ParsePosition(0);
        Vector<Euclidean3D> parse = parse(str, parsePosition);
    ...
    @Override // org.apache.commons.math3.geometry.VectorFormat
    public Vector<Euclidean3D> parse(String str, ParsePosition parsePosition) {
