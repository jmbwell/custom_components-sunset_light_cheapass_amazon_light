...
class FastMathCalc {
    ...
    private static void buildSinCosTables(double[] dArr, double[] dArr2, double[] dArr3, double[] dArr4, int i, double[] dArr5, double[] dArr6) {
        ...
        for (i2 = 7; i2 < i; i2++) {
            ...
            if ((i2 & 1) == 0) {
                ...
                dArr10[0] = dArr[i6];
                dArr10[1] = dArr2[i6];
                double[] dArr12 = {dArr3[i6], dArr4[i6]};
        ...
        for (int i7 = 0; i7 < i; i7++) {
            ...
            double[] dArr14 = {dArr3[i7], dArr4[i7]};
            splitReciprocal(dArr14, dArr13);
            splitMult(new double[]{dArr[i7], dArr2[i7]}, dArr13, dArr14);
            dArr5[i7] = dArr14[0];
            dArr6[i7] = dArr14[1];
        }
    }
    ...
    private static void split(double d, double[] dArr) {
        ...
        double d4 = (((9.313225746154785E-10d * d) + d) - d) * 1.073741824E9d;
        dArr[0] = d4;
        dArr[1] = d - d4;
    }
    ...
    private static void resplit(double[] dArr) {
        ...
        if (d3 < 8.0E298d && d3 > -8.0E298d) {
            double d5 = 1.073741824E9d * d3;
            double d6 = (d3 + d5) - d5;
            dArr[0] = d6;
            dArr[1] = (d3 - d6) + d4;
            return;
        }
        double d7 = (((9.313225746154785E-10d * d3) + d3) - d3) * 1.073741824E9d;
        dArr[0] = d7;
        dArr[1] = (d3 - d7) + d4;
    }
    ...
    public static void printarray(PrintStream printStream, String str, int i, double[][] dArr) {
        ...
        while (i2 < length) {
            ...
            for (int i4 = 0; i4 < length2; i4++) {
                printStream.printf("%-25.25s", format(dArr2[i4]));
            }
    ...
    public static void printarray(PrintStream printStream, String str, int i, double[] dArr) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            printStream.printf("        %s%n", format(dArr[i2]));
        }
        printStream.println(TABLE_END_DECL);
    }
