...
class GillStepInterpolator extends RungeKuttaStepInterpolator {
    ...
    protected void computeInterpolatedStateAndDerivatives(double d, double d2) {
        ...
        if (this.previousState != null && d <= 0.5d) {
            double d12 = (this.h * d) / 6.0d;
            double d13 = ((d * 6.0d) - d4) * d12;
            double d14 = ((6.0d - (9.0d * d)) + d4) * d12;
            double d15 = d7 * d13;
            double d16 = d13 * d9;
            double d17 = d12 * (((-3.0d) * d) + d4);
            for (int i = 0; i < this.interpolatedState.length; i++) {
                double d18 = this.yDotK[0][i];
                double d19 = this.yDotK[1][i];
                double d20 = this.yDotK[2][i];
                double d21 = this.yDotK[3][i];
                this.interpolatedState[i] = this.previousState[i] + (d14 * d18) + (d15 * d19) + (d16 * d20) + (d17 * d21);
                this.interpolatedDerivatives[i] = (d18 * d5) + (d19 * d8) + (d20 * d10) + (d21 * d11);
            }
            return;
        }
        double d22 = d2 / 6.0d;
        double d23 = ((d3 + 2.0d) - d4) * d22;
        double d24 = ((1.0d - (5.0d * d)) + d4) * d22;
        double d25 = d7 * d23;
        double d26 = d23 * d9;
        double d27 = d22 * (d + 1.0d + d4);
        for (int i2 = 0; i2 < this.interpolatedState.length; i2++) {
            ...
            this.interpolatedState[i2] = (((this.currentState[i2] - (d24 * d28)) - (d25 * d29)) - (d26 * d30)) - (d27 * d31);
