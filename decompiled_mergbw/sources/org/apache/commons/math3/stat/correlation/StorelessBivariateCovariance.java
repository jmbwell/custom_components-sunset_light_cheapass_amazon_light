...
class StorelessBivariateCovariance {
    ...
    public void append(StorelessBivariateCovariance storelessBivariateCovariance) {
        double d = this.n;
        double d2 = storelessBivariateCovariance.n + d;
        this.n = d2;
        double d3 = storelessBivariateCovariance.meanX;
        double d4 = this.meanX;
        double d5 = d3 - d4;
        double d6 = storelessBivariateCovariance.meanY;
        double d7 = this.meanY;
        double d8 = d6 - d7;
        double d9 = storelessBivariateCovariance.n;
        this.meanX = d4 + ((d5 * d9) / d2);
        this.meanY = d7 + ((d8 * d9) / d2);
        this.covarianceNumerator += storelessBivariateCovariance.covarianceNumerator + (((d * d9) / d2) * d5 * d8);
    }
