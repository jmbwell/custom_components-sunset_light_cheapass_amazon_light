    ...
    public long getIndex(long j, long j2) {
        ...
        if (j == 0) {
            if (j2 != 1) {
                ...
                return j2 < j5 ? j2 : j3 == 0 ? (j5 << 1) - j2 : -(((j5 << 1) - j2) + 2);
            }
            return Long.MIN_VALUE;
        } else if (j2 <= 1) {
            long j6 = this.rowsl;
            if (j4 == j6) {
                ...
                return (j6 * this.columnsl) >> 1;
            } else if (j4 < j6) {
                return (this.columnsl * j) + j3;
            } else {
                if (j3 == 0) {
                    return this.columnsl * (j6 - j);
                }
                return -((this.columnsl * (j6 - j)) + 1);
            }
        } else {
            ...
            if (j2 != j7 && j2 != j7 + 1) {
                ...
                if (j3 == 0) {
                    return (j7 * ((this.rowsl + 2) - j)) - j2;
                }
                return -(((j7 * ((this.rowsl + 2) - j)) - j2) + 2);
            }
            long j8 = this.rowsl;
            if (j4 == j8) {
                if (j3 == 1) {
