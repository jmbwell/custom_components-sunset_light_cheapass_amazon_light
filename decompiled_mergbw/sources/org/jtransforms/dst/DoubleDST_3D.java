...
public class DoubleDST_3D {
    ...
    public void forward(final double[] dArr, final boolean z) {
        ...
        if (numberOfThreads > 1 && this.useThreads && (i2 = this.slices) >= numberOfThreads && this.rows >= numberOfThreads && this.columns >= numberOfThreads) {
            ...
            while (i5 < numberOfThreads) {
                ...
                futureArr[i5] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.1
                    @Override // java.lang.Runnable
                    public void run() {
                        for (int i8 = i6; i8 < i7; i8++) {
                            int i9 = DoubleDST_3D.this.sliceStride * i8;
                            for (int i10 = 0; i10 < DoubleDST_3D.this.rows; i10++) {
                                DoubleDST_3D.this.dstColumns.forward(dArr, (DoubleDST_3D.this.rowStride * i10) + i9, z);
                            }
                        }
                    }
                });
            ...
            while (i8 < numberOfThreads) {
                ...
                futureArr[i8] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.2
                    @Override // java.lang.Runnable
                    public void run() {
                        double[] dArr2 = new double[DoubleDST_3D.this.rows];
                        for (int i11 = i9; i11 < i10; i11++) {
                            int i12 = DoubleDST_3D.this.sliceStride * i11;
                            for (int i13 = 0; i13 < DoubleDST_3D.this.columns; i13++) {
                                for (int i14 = 0; i14 < DoubleDST_3D.this.rows; i14++) {
                                    dArr2[i14] = dArr[(DoubleDST_3D.this.rowStride * i14) + i12 + i13];
                                }
                                DoubleDST_3D.this.dstRows.forward(dArr2, z);
                                for (int i15 = 0; i15 < DoubleDST_3D.this.rows; i15++) {
                                    dArr[(DoubleDST_3D.this.rowStride * i15) + i12 + i13] = dArr2[i15];
                                }
                            }
                        }
                    }
            ...
            while (i3 < numberOfThreads) {
                ...
                futureArr[i3] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.3
                    @Override // java.lang.Runnable
                    public void run() {
                        double[] dArr2 = new double[DoubleDST_3D.this.slices];
                        for (int i14 = i12; i14 < i13; i14++) {
                            int i15 = DoubleDST_3D.this.rowStride * i14;
                            for (int i16 = 0; i16 < DoubleDST_3D.this.columns; i16++) {
                                for (int i17 = 0; i17 < DoubleDST_3D.this.slices; i17++) {
                                    dArr2[i17] = dArr[(DoubleDST_3D.this.sliceStride * i17) + i15 + i16];
                                }
                                DoubleDST_3D.this.dstSlices.forward(dArr2, z);
                                for (int i18 = 0; i18 < DoubleDST_3D.this.slices; i18++) {
                                    dArr[(DoubleDST_3D.this.sliceStride * i18) + i15 + i16] = dArr2[i18];
                                }
                            }
                        }
                    }
        ...
        for (int i14 = 0; i14 < this.slices; i14++) {
            ...
            for (int i16 = 0; i16 < this.rows; i16++) {
                this.dstColumns.forward(dArr, (this.rowStride * i16) + i15, z);
            }
        }
    ...
    public void forward(final DoubleLargeArray doubleLargeArray, final boolean z) {
        ...
        if (numberOfThreads > 1 && this.useThreads) {
            ...
            if (j >= j2 && this.rowsl >= j2 && this.columnsl >= j2) {
                ...
                while (i < numberOfThreads) {
                    ...
                    futureArr[i] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.4
                        @Override // java.lang.Runnable
                        public void run() {
                            for (long j6 = j4; j6 < j5; j6++) {
                                long j7 = DoubleDST_3D.this.sliceStridel * j6;
                                for (long j8 = 0; j8 < DoubleDST_3D.this.rowsl; j8++) {
                                    DoubleDST_3D.this.dstColumns.forward(doubleLargeArray, (DoubleDST_3D.this.rowStridel * j8) + j7, z);
                                }
                            }
                        }
                    });
                ...
                while (i2 < numberOfThreads) {
                    ...
                    futureArr[i2] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.5
                        @Override // java.lang.Runnable
                        public void run() {
                            DoubleLargeArray doubleLargeArray2 = new DoubleLargeArray(DoubleDST_3D.this.rowsl, false);
                            for (long j9 = j7; j9 < j8; j9++) {
                                long j10 = DoubleDST_3D.this.sliceStridel * j9;
                                for (long j11 = 0; j11 < DoubleDST_3D.this.columnsl; j11++) {
                                    for (long j12 = 0; j12 < DoubleDST_3D.this.rowsl; j12++) {
                                        doubleLargeArray2.setDouble(j12, doubleLargeArray.getDouble((DoubleDST_3D.this.rowStridel * j12) + j10 + j11));
                                    }
                                    DoubleDST_3D.this.dstRows.forward(doubleLargeArray2, z);
                                    long j13 = 0;
                                    while (j13 < DoubleDST_3D.this.rowsl) {
                                        doubleLargeArray.setDouble((DoubleDST_3D.this.rowStridel * j13) + j10 + j11, doubleLargeArray2.getDouble(j13));
                                        j13++;
                                        j10 = j10;
                                    }
                                }
                ...
                try {
                    ...
                    Logger.getLogger(DoubleDST_3D.class.getName()).log(Level.SEVERE, str2, (Throwable) e3);
                } catch (ExecutionException e4) {
                    Logger.getLogger(DoubleDST_3D.class.getName()).log(Level.SEVERE, str2, (Throwable) e4);
                }
                ...
                while (i3 < numberOfThreads) {
                    ...
                    futureArr[i3] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.6
                        @Override // java.lang.Runnable
                        public void run() {
                            DoubleLargeArray doubleLargeArray2 = new DoubleLargeArray(DoubleDST_3D.this.slicesl, false);
                            for (long j12 = j10; j12 < j11; j12++) {
                                long j13 = DoubleDST_3D.this.rowStridel * j12;
                                for (long j14 = 0; j14 < DoubleDST_3D.this.columnsl; j14++) {
                                    for (long j15 = 0; j15 < DoubleDST_3D.this.slicesl; j15++) {
                                        doubleLargeArray2.setDouble(j15, doubleLargeArray.getDouble((DoubleDST_3D.this.sliceStridel * j15) + j13 + j14));
                                    }
                                    DoubleDST_3D.this.dstSlices.forward(doubleLargeArray2, z);
                                    long j16 = 0;
                                    while (j16 < DoubleDST_3D.this.slicesl) {
                                        doubleLargeArray.setDouble((DoubleDST_3D.this.sliceStridel * j16) + j13 + j14, doubleLargeArray2.getDouble(j16));
                                        j16++;
                                        j13 = j13;
                                    }
                                }
                ...
                try {
                    ...
                    Logger.getLogger(DoubleDST_3D.class.getName()).log(Level.SEVERE, str2, (Throwable) e5);
                    return;
                } catch (ExecutionException e6) {
                    Logger.getLogger(DoubleDST_3D.class.getName()).log(Level.SEVERE, str2, (Throwable) e6);
                    return;
                }
            }
        }
        for (long j12 = 0; j12 < this.slicesl; j12++) {
            ...
            for (long j14 = 0; j14 < this.rowsl; j14++) {
                this.dstColumns.forward(doubleLargeArray, (this.rowStridel * j14) + j13, z);
            }
        }
    ...
    public void forward(final double[][][] dArr, final boolean z) {
        ...
        if (numberOfThreads > 1 && this.useThreads && (i2 = this.slices) >= numberOfThreads && this.rows >= numberOfThreads && this.columns >= numberOfThreads) {
            ...
            while (i5 < numberOfThreads) {
                final int i6 = i5 * i4;
                final int i7 = i5 == numberOfThreads + (-1) ? this.slices : i6 + i4;
                futureArr[i5] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.7
                    @Override // java.lang.Runnable
                    public void run() {
                        for (int i8 = i6; i8 < i7; i8++) {
                            for (int i9 = 0; i9 < DoubleDST_3D.this.rows; i9++) {
                                DoubleDST_3D.this.dstColumns.forward(dArr[i8][i9], z);
                            }
                        }
                    }
                });
            ...
            while (i8 < numberOfThreads) {
                final int i9 = i8 * i4;
                final int i10 = i8 == numberOfThreads + (-1) ? this.slices : i9 + i4;
                futureArr[i8] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.8
                    @Override // java.lang.Runnable
                    public void run() {
                        double[] dArr2 = new double[DoubleDST_3D.this.rows];
                        for (int i11 = i9; i11 < i10; i11++) {
                            for (int i12 = 0; i12 < DoubleDST_3D.this.columns; i12++) {
            ...
            while (i3 < numberOfThreads) {
                final int i12 = i3 * i11;
                final int i13 = i3 == numberOfThreads + (-1) ? this.rows : i12 + i11;
                futureArr[i3] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.9
                    @Override // java.lang.Runnable
                    public void run() {
                        double[] dArr2 = new double[DoubleDST_3D.this.slices];
                        for (int i14 = i12; i14 < i13; i14++) {
                            for (int i15 = 0; i15 < DoubleDST_3D.this.columns; i15++) {
        ...
        for (int i14 = 0; i14 < this.slices; i14++) {
            for (int i15 = 0; i15 < this.rows; i15++) {
                this.dstColumns.forward(dArr[i14][i15], z);
            }
        }
        double[] dArr2 = new double[this.rows];
        int i16 = 0;
    ...
    public void inverse(final double[] dArr, final boolean z) {
        ...
        if (numberOfThreads > 1 && this.useThreads && (i2 = this.slices) >= numberOfThreads && this.rows >= numberOfThreads && this.columns >= numberOfThreads) {
            ...
            while (i5 < numberOfThreads) {
                final int i6 = i5 * i4;
                final int i7 = i5 == numberOfThreads + (-1) ? this.slices : i6 + i4;
                futureArr[i5] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.10
                    @Override // java.lang.Runnable
                    public void run() {
                        for (int i8 = i6; i8 < i7; i8++) {
                            int i9 = DoubleDST_3D.this.sliceStride * i8;
                            for (int i10 = 0; i10 < DoubleDST_3D.this.rows; i10++) {
                                DoubleDST_3D.this.dstColumns.inverse(dArr, (DoubleDST_3D.this.rowStride * i10) + i9, z);
                            }
                        }
                    }
                });
            ...
            while (i8 < numberOfThreads) {
                final int i9 = i8 * i4;
                final int i10 = i8 == numberOfThreads + (-1) ? this.slices : i9 + i4;
                futureArr[i8] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.11
                    @Override // java.lang.Runnable
                    public void run() {
                        double[] dArr2 = new double[DoubleDST_3D.this.rows];
                        for (int i11 = i9; i11 < i10; i11++) {
                            ...
                            for (int i13 = 0; i13 < DoubleDST_3D.this.columns; i13++) {
                                ...
                                DoubleDST_3D.this.dstRows.inverse(dArr2, z);
                                for (int i15 = 0; i15 < DoubleDST_3D.this.rows; i15++) {
                                    dArr[(DoubleDST_3D.this.rowStride * i15) + i12 + i13] = dArr2[i15];
                                }
                            }
            ...
            while (i3 < numberOfThreads) {
                final int i12 = i3 * i11;
                final int i13 = i3 == numberOfThreads + (-1) ? this.rows : i12 + i11;
                futureArr[i3] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.12
                    @Override // java.lang.Runnable
                    public void run() {
                        double[] dArr2 = new double[DoubleDST_3D.this.slices];
                        for (int i14 = i12; i14 < i13; i14++) {
                            ...
                            for (int i16 = 0; i16 < DoubleDST_3D.this.columns; i16++) {
                                ...
                                DoubleDST_3D.this.dstSlices.inverse(dArr2, z);
                                for (int i18 = 0; i18 < DoubleDST_3D.this.slices; i18++) {
                                    dArr[(DoubleDST_3D.this.sliceStride * i18) + i15 + i16] = dArr2[i18];
                                }
                            }
        ...
        for (int i14 = 0; i14 < this.slices; i14++) {
            int i15 = this.sliceStride * i14;
            for (int i16 = 0; i16 < this.rows; i16++) {
                this.dstColumns.inverse(dArr, (this.rowStride * i16) + i15, z);
            }
        }
        double[] dArr2 = new double[this.rows];
        int i17 = 0;
    ...
    public void inverse(final DoubleLargeArray doubleLargeArray, final boolean z) {
        ...
        if (numberOfThreads > 1 && this.useThreads) {
            ...
            if (j >= j2 && this.rowsl >= j2 && this.columnsl >= j2) {
                ...
                while (i < numberOfThreads) {
                    final long j4 = i * j3;
                    final long j5 = i == numberOfThreads + (-1) ? this.slicesl : j4 + j3;
                    futureArr[i] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.13
                        @Override // java.lang.Runnable
                        public void run() {
                            for (long j6 = j4; j6 < j5; j6++) {
                                long j7 = DoubleDST_3D.this.sliceStride * j6;
                                for (long j8 = 0; j8 < DoubleDST_3D.this.rowsl; j8++) {
                                    DoubleDST_3D.this.dstColumns.inverse(doubleLargeArray, (DoubleDST_3D.this.rowStride * j8) + j7, z);
                                }
                            }
                        }
                    });
                ...
                while (i2 < numberOfThreads) {
                    final long j7 = i2 * j3;
                    final long j8 = i2 == numberOfThreads + (-1) ? this.slicesl : j7 + j3;
                    futureArr[i2] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.14
                        @Override // java.lang.Runnable
                        public void run() {
                            DoubleLargeArray doubleLargeArray2 = new DoubleLargeArray(DoubleDST_3D.this.rowsl, false);
                            for (long j9 = j7; j9 < j8; j9++) {
                                long j10 = DoubleDST_3D.this.sliceStride * j9;
                                for (long j11 = 0; j11 < DoubleDST_3D.this.columnsl; j11++) {
                                    for (long j12 = 0; j12 < DoubleDST_3D.this.rowsl; j12++) {
                                        doubleLargeArray2.setDouble(j12, doubleLargeArray.getDouble((DoubleDST_3D.this.rowStride * j12) + j10 + j11));
                                    }
                                    DoubleDST_3D.this.dstRows.inverse(doubleLargeArray2, z);
                                    long j13 = 0;
                                    while (j13 < DoubleDST_3D.this.rowsl) {
                                        doubleLargeArray.setDouble((DoubleDST_3D.this.rowStride * j13) + j10 + j11, doubleLargeArray2.getDouble(j13));
                                        j13++;
                                        j10 = j10;
                                    }
                                }
                ...
                while (i3 < numberOfThreads) {
                    final long j10 = i3 * j9;
                    final long j11 = i3 == numberOfThreads + (-1) ? this.rowsl : j10 + j9;
                    futureArr[i3] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.15
                        @Override // java.lang.Runnable
                        public void run() {
                            DoubleLargeArray doubleLargeArray2 = new DoubleLargeArray(DoubleDST_3D.this.slicesl, false);
                            for (long j12 = j10; j12 < j11; j12++) {
                                long j13 = DoubleDST_3D.this.rowStride * j12;
                                for (long j14 = 0; j14 < DoubleDST_3D.this.columnsl; j14++) {
                                    for (long j15 = 0; j15 < DoubleDST_3D.this.slicesl; j15++) {
                                        doubleLargeArray2.setDouble(j15, doubleLargeArray.getDouble((DoubleDST_3D.this.sliceStride * j15) + j13 + j14));
                                    }
                                    DoubleDST_3D.this.dstSlices.inverse(doubleLargeArray2, z);
                                    long j16 = 0;
                                    while (j16 < DoubleDST_3D.this.slicesl) {
                                        doubleLargeArray.setDouble((DoubleDST_3D.this.sliceStride * j16) + j13 + j14, doubleLargeArray2.getDouble(j16));
                                        j16++;
                                        j13 = j13;
                                    }
                                }
        ...
        for (long j12 = 0; j12 < this.slicesl; j12++) {
            ...
            for (long j14 = 0; j14 < this.rowsl; j14++) {
                this.dstColumns.inverse(doubleLargeArray, (this.rowStride * j14) + j13, z);
            }
        }
        DoubleLargeArray doubleLargeArray2 = new DoubleLargeArray(this.rowsl, false);
        for (long j15 = 0; j15 < this.slicesl; j15++) {
            ...
            for (long j17 = 0; j17 < this.columnsl; j17++) {
                for (long j18 = 0; j18 < this.rowsl; j18++) {
                    doubleLargeArray2.setDouble(j18, doubleLargeArray.getDouble((this.rowStride * j18) + j16 + j17));
                }
                this.dstRows.inverse(doubleLargeArray2, z);
                long j19 = 0;
                while (j19 < this.rowsl) {
                    doubleLargeArray.setDouble((this.rowStride * j19) + j16 + j17, doubleLargeArray2.getDouble(j19));
                    j19++;
                    j16 = j16;
                }
            }
        ...
        for (long j20 = 0; j20 < this.rowsl; j20++) {
            ...
            for (long j22 = 0; j22 < this.columnsl; j22++) {
                for (long j23 = 0; j23 < this.slicesl; j23++) {
                    doubleLargeArray3.setDouble(j23, doubleLargeArray.getDouble((this.sliceStride * j23) + j21 + j22));
                }
                this.dstSlices.inverse(doubleLargeArray3, z);
                long j24 = 0;
                while (j24 < this.slicesl) {
                    doubleLargeArray.setDouble((this.sliceStride * j24) + j21 + j22, doubleLargeArray3.getDouble(j24));
                    j24++;
                    j21 = j21;
                }
            }
    ...
    public void inverse(final double[][][] dArr, final boolean z) {
        ...
        if (numberOfThreads > 1 && this.useThreads && (i2 = this.slices) >= numberOfThreads && this.rows >= numberOfThreads && this.columns >= numberOfThreads) {
            ...
            while (i5 < numberOfThreads) {
                final int i6 = i5 * i4;
                final int i7 = i5 == numberOfThreads + (-1) ? this.slices : i6 + i4;
                futureArr[i5] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.16
                    @Override // java.lang.Runnable
                    public void run() {
                        for (int i8 = i6; i8 < i7; i8++) {
                            for (int i9 = 0; i9 < DoubleDST_3D.this.rows; i9++) {
                                DoubleDST_3D.this.dstColumns.inverse(dArr[i8][i9], z);
                            }
                        }
                    }
                });
            ...
            while (i8 < numberOfThreads) {
                final int i9 = i8 * i4;
                final int i10 = i8 == numberOfThreads + (-1) ? this.slices : i9 + i4;
                futureArr[i8] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.17
                    @Override // java.lang.Runnable
                    public void run() {
                        double[] dArr2 = new double[DoubleDST_3D.this.rows];
                        for (int i11 = i9; i11 < i10; i11++) {
            ...
            while (i3 < numberOfThreads) {
                final int i12 = i3 * i11;
                final int i13 = i3 == numberOfThreads + (-1) ? this.rows : i12 + i11;
                futureArr[i3] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.18
                    @Override // java.lang.Runnable
                    public void run() {
                        double[] dArr2 = new double[DoubleDST_3D.this.slices];
                        for (int i14 = i12; i14 < i13; i14++) {
        ...
        for (int i14 = 0; i14 < this.slices; i14++) {
            for (int i15 = 0; i15 < this.rows; i15++) {
                this.dstColumns.inverse(dArr[i14][i15], z);
            }
        }
        double[] dArr2 = new double[this.rows];
        int i16 = 0;
    ...
    private void ddxt3da_sub(int i, DoubleLargeArray doubleLargeArray, boolean z) {
        ...
        if (i == -1) {
            ...
            while (j5 < this.slicesl) {
                ...
                for (long j7 = 0; j7 < this.rowsl; j7++) {
                    this.dstColumns.forward(doubleLargeArray, (this.rowStride * j7) + j6, z3);
                }
                ...
                if (j8 > j4) {
                    ...
                    while (j9 < this.columnsl) {
                        ...
                        this.dstRows.forward(doubleLargeArray2, this.rowsl * 3, z3);
                        long j18 = 0;
                        while (true) {
                            long j19 = this.rowsl;
                            if (j18 < j19) {
        ...
        while (j26 < this.slicesl) {
            ...
            for (long j28 = 0; j28 < this.rowsl; j28++) {
                this.dstColumns.inverse(doubleLargeArray, (this.rowStridel * j28) + j27, z3);
            }
            ...
            if (j29 > 2) {
                ...
                while (true) {
                    ...
                    long j35 = j27;
                    long j36 = j30;
                    this.dstRows.inverse(doubleLargeArray2, 0L, z3);
                    this.dstRows.inverse(doubleLargeArray2, this.rowsl, z3);
                    this.dstRows.inverse(doubleLargeArray2, this.rowsl * 2, z3);
                    this.dstRows.inverse(doubleLargeArray2, this.rowsl * 3, z3);
                    long j37 = 0;
                    while (true) {
                        long j38 = this.rowsl;
                        if (j37 < j38) {
                ...
                if (j29 == 2) {
                    ...
                    z2 = z;
                    this.dstRows.inverse(doubleLargeArray2, 0L, z2);
                    this.dstRows.inverse(doubleLargeArray2, this.rowsl, z2);
    ...
    private void ddxt3db_sub(int i, DoubleLargeArray doubleLargeArray, boolean z) {
        ...
        if (i == -1) {
            ...
            while (j10 < this.rowsl) {
                ...
                while (j12 < this.columnsl) {
                    ...
                    this.dstSlices.forward(doubleLargeArray2, this.slicesl * 3, z2);
                    long j19 = 0;
                    while (true) {
        ...
        while (j30 < this.rowsl) {
            ...
            while (j32 < this.columnsl) {
                ...
                long j38 = j31;
                long j39 = j32;
                this.dstSlices.inverse(doubleLargeArray2, 0L, z2);
                this.dstSlices.inverse(doubleLargeArray2, this.slicesl, z2);
                this.dstSlices.inverse(doubleLargeArray2, this.slicesl * 2, z2);
                this.dstSlices.inverse(doubleLargeArray2, this.slicesl * 3, z2);
                long j40 = 0;
                while (true) {
    ...
    private void ddxt3da_subth(final int i, final double[] dArr, final boolean z) {
        ...
        for (int i6 = 0; i6 < i3; i6++) {
            final int i7 = i6;
            futureArr[i6] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.19
                @Override // java.lang.Runnable
                public void run() {
                    ...
                    if (i == -1) {
                        ...
                        while (i8 < DoubleDST_3D.this.slices) {
                            ...
                            if (DoubleDST_3D.this.columns > 2) {
                                for (int i11 = 0; i11 < DoubleDST_3D.this.columns; i11 += 4) {
                                    for (int i12 = 0; i12 < DoubleDST_3D.this.rows; i12++) {
                                        int i13 = (DoubleDST_3D.this.rowStride * i12) + i9 + i11;
                                        int i14 = DoubleDST_3D.this.rows + i12;
                                        double[] dArr3 = dArr;
                                        dArr2[i12] = dArr3[i13];
                                        dArr2[i14] = dArr3[i13 + 1];
                                        dArr2[DoubleDST_3D.this.rows + i14] = dArr[i13 + 2];
                                        dArr2[i14 + (DoubleDST_3D.this.rows * 2)] = dArr[i13 + 3];
                                    }
                                    ...
                                    for (int i15 = 0; i15 < DoubleDST_3D.this.rows; i15++) {
                                        int i16 = (DoubleDST_3D.this.rowStride * i15) + i9 + i11;
                                        int i17 = DoubleDST_3D.this.rows + i15;
                                        double[] dArr4 = dArr;
                                        dArr4[i16] = dArr2[i15];
                                        dArr4[i16 + 1] = dArr2[i17];
                                        dArr4[i16 + 2] = dArr2[DoubleDST_3D.this.rows + i17];
                                        dArr[i16 + 3] = dArr2[i17 + (DoubleDST_3D.this.rows * 2)];
                                    }
                                }
                            } else if (DoubleDST_3D.this.columns == 2) {
                                for (int i18 = 0; i18 < DoubleDST_3D.this.rows; i18++) {
                                    int i19 = (DoubleDST_3D.this.rowStride * i18) + i9;
                                    dArr2[i18] = dArr[i19];
                                    dArr2[DoubleDST_3D.this.rows + i18] = dArr[i19 + 1];
                                }
                                DoubleDST_3D.this.dstRows.forward(dArr2, 0, z);
                                DoubleDST_3D.this.dstRows.forward(dArr2, DoubleDST_3D.this.rows, z);
                                for (int i20 = 0; i20 < DoubleDST_3D.this.rows; i20++) {
                                    int i21 = (DoubleDST_3D.this.rowStride * i20) + i9;
                                    double[] dArr5 = dArr;
                                    dArr5[i21] = dArr2[i20];
                                    dArr5[i21 + 1] = dArr2[DoubleDST_3D.this.rows + i20];
                                }
                            }
                            i8 += i3;
                        }
                    ...
                    int i22 = i7;
                    while (i22 < DoubleDST_3D.this.slices) {
                        int i23 = DoubleDST_3D.this.sliceStride * i22;
                        for (int i24 = 0; i24 < DoubleDST_3D.this.rows; i24++) {
                            DoubleDST_3D.this.dstColumns.inverse(dArr, (DoubleDST_3D.this.rowStride * i24) + i23, z);
                        }
                        if (DoubleDST_3D.this.columns > 2) {
                            for (int i25 = 0; i25 < DoubleDST_3D.this.columns; i25 += 4) {
                                for (int i26 = 0; i26 < DoubleDST_3D.this.rows; i26++) {
                                    int i27 = (DoubleDST_3D.this.rowStride * i26) + i23 + i25;
                                    int i28 = DoubleDST_3D.this.rows + i26;
                                    double[] dArr6 = dArr;
                                    dArr2[i26] = dArr6[i27];
                                    dArr2[i28] = dArr6[i27 + 1];
                                    dArr2[DoubleDST_3D.this.rows + i28] = dArr[i27 + 2];
                                    dArr2[i28 + (DoubleDST_3D.this.rows * 2)] = dArr[i27 + 3];
                                }
                                ...
                                for (int i29 = 0; i29 < DoubleDST_3D.this.rows; i29++) {
                                    int i30 = (DoubleDST_3D.this.rowStride * i29) + i23 + i25;
                                    int i31 = DoubleDST_3D.this.rows + i29;
                                    double[] dArr7 = dArr;
                                    dArr7[i30] = dArr2[i29];
                                    dArr7[i30 + 1] = dArr2[i31];
                                    dArr7[i30 + 2] = dArr2[DoubleDST_3D.this.rows + i31];
                                    dArr[i30 + 3] = dArr2[i31 + (DoubleDST_3D.this.rows * 2)];
                                }
                            }
                        } else if (DoubleDST_3D.this.columns == 2) {
                            for (int i32 = 0; i32 < DoubleDST_3D.this.rows; i32++) {
                                int i33 = (DoubleDST_3D.this.rowStride * i32) + i23;
                                dArr2[i32] = dArr[i33];
                                dArr2[DoubleDST_3D.this.rows + i32] = dArr[i33 + 1];
                            }
                            DoubleDST_3D.this.dstRows.inverse(dArr2, 0, z);
                            DoubleDST_3D.this.dstRows.inverse(dArr2, DoubleDST_3D.this.rows, z);
                            for (int i34 = 0; i34 < DoubleDST_3D.this.rows; i34++) {
                                int i35 = (DoubleDST_3D.this.rowStride * i34) + i23;
                                double[] dArr8 = dArr;
                                dArr8[i35] = dArr2[i34];
                                dArr8[i35 + 1] = dArr2[DoubleDST_3D.this.rows + i34];
                            }
                        }
                        i22 += i3;
                    }
    ...
    private void ddxt3da_subth(final int i, final DoubleLargeArray doubleLargeArray, final boolean z) {
        ...
        while (i3 < i2) {
            final long j4 = i3;
            int i4 = i3;
            futureArr[i4] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.20
                @Override // java.lang.Runnable
                public void run() {
                    long j5;
                    long j6;
                    ...
                    if (i == -1) {
                        long j9 = j4;
                        while (j9 < DoubleDST_3D.this.slicesl) {
                            long j10 = DoubleDST_3D.this.sliceStridel * j9;
                            for (long j11 = 0; j11 < DoubleDST_3D.this.rowsl; j11 += j8) {
                                DoubleDST_3D.this.dstColumns.forward(doubleLargeArray, (DoubleDST_3D.this.rowStridel * j11) + j10, z);
                            }
                            if (DoubleDST_3D.this.columnsl > j7) {
                                long j12 = 0;
                                while (j12 < DoubleDST_3D.this.columnsl) {
                                    long j13 = 0;
                                    while (j13 < DoubleDST_3D.this.rowsl) {
                                        long j14 = (DoubleDST_3D.this.rowStridel * j13) + j10 + j12;
                                        long j15 = DoubleDST_3D.this.rowsl + j13;
                                        ...
                                        doubleLargeArray2.setDouble(DoubleDST_3D.this.rowsl + j15, doubleLargeArray.getDouble(j14 + 2));
                                        doubleLargeArray2.setDouble(j15 + (DoubleDST_3D.this.rowsl * 2), doubleLargeArray.getDouble(j14 + 3));
                                        j13++;
                                        j9 = j9;
                                        j12 = j12;
                                    }
                                    ...
                                    DoubleDST_3D.this.dstRows.forward(doubleLargeArray2, DoubleDST_3D.this.rowsl * 2, z);
                                    DoubleDST_3D.this.dstRows.forward(doubleLargeArray2, DoubleDST_3D.this.rowsl * 3, z);
                                    for (long j18 = 0; j18 < DoubleDST_3D.this.rowsl; j18++) {
                                        long j19 = (DoubleDST_3D.this.rowStridel * j18) + j10 + j17;
                                        long j20 = DoubleDST_3D.this.rowsl + j18;
                                        ...
                                        doubleLargeArray.setDouble(j19 + 2, doubleLargeArray2.getDouble(j20 + DoubleDST_3D.this.rowsl));
                                        doubleLargeArray.setDouble(j19 + 3, doubleLargeArray2.getDouble(j20 + (DoubleDST_3D.this.rowsl * 2)));
                                    }
                                    j12 = j17 + 4;
                                    j9 = j16;
                                }
                                ...
                                if (DoubleDST_3D.this.columnsl == j7) {
                                    for (long j21 = 0; j21 < DoubleDST_3D.this.rowsl; j21++) {
                                        long j22 = (DoubleDST_3D.this.rowStridel * j21) + j10;
                                        doubleLargeArray2.setDouble(j21, doubleLargeArray.getDouble(j22));
                                        doubleLargeArray2.setDouble(DoubleDST_3D.this.rowsl + j21, doubleLargeArray.getDouble(j22 + 1));
                                    }
                                    DoubleDST_3D.this.dstRows.forward(doubleLargeArray2, 0L, z);
                                    DoubleDST_3D.this.dstRows.forward(doubleLargeArray2, DoubleDST_3D.this.rowsl, z);
                                    for (long j23 = 0; j23 < DoubleDST_3D.this.rowsl; j23++) {
                                        long j24 = (DoubleDST_3D.this.rowStridel * j23) + j10;
                                        doubleLargeArray.setDouble(j24, doubleLargeArray2.getDouble(j23));
                                        doubleLargeArray.setDouble(j24 + 1, doubleLargeArray2.getDouble(DoubleDST_3D.this.rowsl + j23));
                                    }
                                }
                            }
                            j9 = j6 + i2;
                    ...
                    while (j25 < DoubleDST_3D.this.slicesl) {
                        long j26 = DoubleDST_3D.this.sliceStridel * j25;
                        for (long j27 = 0; j27 < DoubleDST_3D.this.rowsl; j27++) {
                            DoubleDST_3D.this.dstColumns.inverse(doubleLargeArray, (DoubleDST_3D.this.rowStridel * j27) + j26, z);
                        }
                        if (DoubleDST_3D.this.columnsl > 2) {
                            long j28 = 0;
                            while (j28 < DoubleDST_3D.this.columnsl) {
                                long j29 = 0;
                                while (j29 < DoubleDST_3D.this.rowsl) {
                                    long j30 = (DoubleDST_3D.this.rowStridel * j29) + j26 + j28;
                                    long j31 = DoubleDST_3D.this.rowsl + j29;
                                    ...
                                    doubleLargeArray2.setDouble(DoubleDST_3D.this.rowsl + j31, doubleLargeArray.getDouble(j30 + 2));
                                    doubleLargeArray2.setDouble(j31 + (DoubleDST_3D.this.rowsl * 2), doubleLargeArray.getDouble(j30 + 3));
                                    j29++;
                                    j25 = j25;
                                    j28 = j28;
                                }
                                ...
                                for (long j34 = 0; j34 < DoubleDST_3D.this.rowsl; j34++) {
                                    long j35 = (DoubleDST_3D.this.rowStridel * j34) + j26 + j33;
                                    long j36 = DoubleDST_3D.this.rowsl + j34;
                                    ...
                                    doubleLargeArray.setDouble(j35 + 2, doubleLargeArray2.getDouble(j36 + DoubleDST_3D.this.rowsl));
                                    doubleLargeArray.setDouble(j35 + 3, doubleLargeArray2.getDouble(j36 + (DoubleDST_3D.this.rowsl * 2)));
                                }
                                j28 = j33 + 4;
                                j25 = j32;
                            }
                            ...
                            j5 = j25;
                            if (DoubleDST_3D.this.columnsl == 2) {
                                for (long j37 = 0; j37 < DoubleDST_3D.this.rowsl; j37++) {
                                    long j38 = (DoubleDST_3D.this.rowStridel * j37) + j26;
                                    doubleLargeArray2.setDouble(j37, doubleLargeArray.getDouble(j38));
                                    doubleLargeArray2.setDouble(DoubleDST_3D.this.rowsl + j37, doubleLargeArray.getDouble(j38 + 1));
                                }
                                DoubleDST_3D.this.dstRows.inverse(doubleLargeArray2, 0L, z);
                                DoubleDST_3D.this.dstRows.inverse(doubleLargeArray2, DoubleDST_3D.this.rowsl, z);
                                for (long j39 = 0; j39 < DoubleDST_3D.this.rowsl; j39++) {
                                    long j40 = (DoubleDST_3D.this.rowStridel * j39) + j26;
                                    doubleLargeArray.setDouble(j40, doubleLargeArray2.getDouble(j39));
                                    doubleLargeArray.setDouble(j40 + 1, doubleLargeArray2.getDouble(DoubleDST_3D.this.rowsl + j39));
                                }
                            }
                        }
                        j25 = j5 + i2;
    ...
    private void ddxt3da_subth(final int i, final double[][][] dArr, final boolean z) {
        ...
        for (int i6 = 0; i6 < i3; i6++) {
            final int i7 = i6;
            futureArr[i6] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.21
                @Override // java.lang.Runnable
                public void run() {
                    double[] dArr2 = new double[i5];
                    if (i == -1) {
                            ...
                            if (DoubleDST_3D.this.columns > 2) {
                                for (int i10 = 0; i10 < DoubleDST_3D.this.columns; i10 += 4) {
                                    for (int i11 = 0; i11 < DoubleDST_3D.this.rows; i11++) {
                                        ...
                                        dArr2[DoubleDST_3D.this.rows + i12] = dArr[i8][i11][i10 + 2];
                                        dArr2[i12 + (DoubleDST_3D.this.rows * 2)] = dArr[i8][i11][i10 + 3];
                                    }
                                    DoubleDST_3D.this.dstRows.forward(dArr2, 0, z);
                                    DoubleDST_3D.this.dstRows.forward(dArr2, DoubleDST_3D.this.rows, z);
                                    DoubleDST_3D.this.dstRows.forward(dArr2, DoubleDST_3D.this.rows * 2, z);
                                    DoubleDST_3D.this.dstRows.forward(dArr2, DoubleDST_3D.this.rows * 3, z);
                                    for (int i13 = 0; i13 < DoubleDST_3D.this.rows; i13++) {
                                        int i14 = DoubleDST_3D.this.rows + i13;
                                        double[] dArr4 = dArr[i8][i13];
                                        dArr4[i10] = dArr2[i13];
                                        dArr4[i10 + 1] = dArr2[i14];
                                        dArr4[i10 + 2] = dArr2[DoubleDST_3D.this.rows + i14];
                                        dArr[i8][i13][i10 + 3] = dArr2[i14 + (DoubleDST_3D.this.rows * 2)];
                                    }
                                }
                            } else if (DoubleDST_3D.this.columns == 2) {
                                for (int i15 = 0; i15 < DoubleDST_3D.this.rows; i15++) {
                                    dArr2[i15] = dArr[i8][i15][0];
                                    dArr2[DoubleDST_3D.this.rows + i15] = dArr[i8][i15][1];
                                }
                                DoubleDST_3D.this.dstRows.forward(dArr2, 0, z);
                                DoubleDST_3D.this.dstRows.forward(dArr2, DoubleDST_3D.this.rows, z);
                                for (int i16 = 0; i16 < DoubleDST_3D.this.rows; i16++) {
                                    ...
                                    dArr5[0] = dArr2[i16];
                                    dArr5[1] = dArr2[DoubleDST_3D.this.rows + i16];
                                }
                            }
                            i8 += i3;
                        }
                    ...
                    int i17 = i7;
                    while (i17 < DoubleDST_3D.this.slices) {
                        for (int i18 = 0; i18 < DoubleDST_3D.this.rows; i18++) {
                            DoubleDST_3D.this.dstColumns.inverse(dArr[i17][i18], z);
                        }
                        if (DoubleDST_3D.this.columns > 2) {
                            for (int i19 = 0; i19 < DoubleDST_3D.this.columns; i19 += 4) {
                                for (int i20 = 0; i20 < DoubleDST_3D.this.rows; i20++) {
                                    ...
                                    dArr2[DoubleDST_3D.this.rows + i21] = dArr[i17][i20][i19 + 2];
                                    dArr2[i21 + (DoubleDST_3D.this.rows * 2)] = dArr[i17][i20][i19 + 3];
                                }
                                DoubleDST_3D.this.dstRows.inverse(dArr2, 0, z);
                                DoubleDST_3D.this.dstRows.inverse(dArr2, DoubleDST_3D.this.rows, z);
                                DoubleDST_3D.this.dstRows.inverse(dArr2, DoubleDST_3D.this.rows * 2, z);
                                ...
                                for (int i22 = 0; i22 < DoubleDST_3D.this.rows; i22++) {
                                    int i23 = DoubleDST_3D.this.rows + i22;
                                    double[] dArr7 = dArr[i17][i22];
                                    dArr7[i19] = dArr2[i22];
                                    dArr7[i19 + 1] = dArr2[i23];
                                    dArr7[i19 + 2] = dArr2[DoubleDST_3D.this.rows + i23];
                                    dArr[i17][i22][i19 + 3] = dArr2[i23 + (DoubleDST_3D.this.rows * 2)];
                                }
                            }
                        } else if (DoubleDST_3D.this.columns == 2) {
                            for (int i24 = 0; i24 < DoubleDST_3D.this.rows; i24++) {
                                dArr2[i24] = dArr[i17][i24][0];
                                dArr2[DoubleDST_3D.this.rows + i24] = dArr[i17][i24][1];
                            }
                            DoubleDST_3D.this.dstRows.inverse(dArr2, 0, z);
                            DoubleDST_3D.this.dstRows.inverse(dArr2, DoubleDST_3D.this.rows, z);
                            for (int i25 = 0; i25 < DoubleDST_3D.this.rows; i25++) {
                                double[] dArr8 = dArr[i17][i25];
                                dArr8[0] = dArr2[i25];
                                dArr8[1] = dArr2[DoubleDST_3D.this.rows + i25];
                            }
                        }
                        i17 += i3;
                    }
    ...
    private void ddxt3db_subth(final int i, final double[] dArr, final boolean z) {
        ...
        for (int i6 = 0; i6 < i3; i6++) {
            final int i7 = i6;
            futureArr[i6] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.22
                @Override // java.lang.Runnable
                public void run() {
                    double[] dArr2 = new double[i5];
                    if (i == -1) {
                        if (DoubleDST_3D.this.columns <= 2) {
                            if (DoubleDST_3D.this.columns == 2) {
                                ...
                                while (i8 < DoubleDST_3D.this.rows) {
                                    int i9 = DoubleDST_3D.this.rowStride * i8;
                                    for (int i10 = 0; i10 < DoubleDST_3D.this.slices; i10++) {
                                        int i11 = (DoubleDST_3D.this.sliceStride * i10) + i9;
                                        dArr2[i10] = dArr[i11];
                                        dArr2[DoubleDST_3D.this.slices + i10] = dArr[i11 + 1];
                                    }
                                    DoubleDST_3D.this.dstSlices.forward(dArr2, 0, z);
                                    DoubleDST_3D.this.dstSlices.forward(dArr2, DoubleDST_3D.this.slices, z);
                                    for (int i12 = 0; i12 < DoubleDST_3D.this.slices; i12++) {
                                        int i13 = (DoubleDST_3D.this.sliceStride * i12) + i9;
                                        double[] dArr3 = dArr;
                                        dArr3[i13] = dArr2[i12];
                                        dArr3[i13 + 1] = dArr2[DoubleDST_3D.this.slices + i12];
                                    }
                                    i8 += i3;
                                }
                                return;
                        ...
                        int i14 = i7;
                        while (i14 < DoubleDST_3D.this.rows) {
                            int i15 = DoubleDST_3D.this.rowStride * i14;
                            for (int i16 = 0; i16 < DoubleDST_3D.this.columns; i16 += 4) {
                                for (int i17 = 0; i17 < DoubleDST_3D.this.slices; i17++) {
                                    int i18 = (DoubleDST_3D.this.sliceStride * i17) + i15 + i16;
                                    int i19 = DoubleDST_3D.this.slices + i17;
                                    double[] dArr4 = dArr;
                                    dArr2[i17] = dArr4[i18];
                                    dArr2[i19] = dArr4[i18 + 1];
                                    dArr2[DoubleDST_3D.this.slices + i19] = dArr[i18 + 2];
                                    dArr2[i19 + (DoubleDST_3D.this.slices * 2)] = dArr[i18 + 3];
                                }
                                DoubleDST_3D.this.dstSlices.forward(dArr2, 0, z);
                                DoubleDST_3D.this.dstSlices.forward(dArr2, DoubleDST_3D.this.slices, z);
                                ...
                                for (int i20 = 0; i20 < DoubleDST_3D.this.slices; i20++) {
                                    int i21 = (DoubleDST_3D.this.sliceStride * i20) + i15 + i16;
                                    int i22 = DoubleDST_3D.this.slices + i20;
                                    double[] dArr5 = dArr;
                                    dArr5[i21] = dArr2[i20];
                                    dArr5[i21 + 1] = dArr2[i22];
                                    dArr5[i21 + 2] = dArr2[DoubleDST_3D.this.slices + i22];
                                    dArr[i21 + 3] = dArr2[i22 + (DoubleDST_3D.this.slices * 2)];
                                }
                            }
                            i14 += i3;
                        }
                        ...
                        if (DoubleDST_3D.this.columns == 2) {
                            int i23 = i7;
                            while (i23 < DoubleDST_3D.this.rows) {
                                int i24 = DoubleDST_3D.this.rowStride * i23;
                                for (int i25 = 0; i25 < DoubleDST_3D.this.slices; i25++) {
                                    int i26 = (DoubleDST_3D.this.sliceStride * i25) + i24;
                                    dArr2[i25] = dArr[i26];
                                    dArr2[DoubleDST_3D.this.slices + i25] = dArr[i26 + 1];
                                }
                                ...
                                for (int i27 = 0; i27 < DoubleDST_3D.this.slices; i27++) {
                                    int i28 = (DoubleDST_3D.this.sliceStride * i27) + i24;
                                    double[] dArr6 = dArr;
                                    dArr6[i28] = dArr2[i27];
                                    dArr6[i28 + 1] = dArr2[DoubleDST_3D.this.slices + i27];
                                }
                                i23 += i3;
                            }
                        }
                        ...
                        int i29 = i7;
                        while (i29 < DoubleDST_3D.this.rows) {
                            int i30 = DoubleDST_3D.this.rowStride * i29;
                            for (int i31 = 0; i31 < DoubleDST_3D.this.columns; i31 += 4) {
                                for (int i32 = 0; i32 < DoubleDST_3D.this.slices; i32++) {
                                    int i33 = (DoubleDST_3D.this.sliceStride * i32) + i30 + i31;
                                    int i34 = DoubleDST_3D.this.slices + i32;
                                    double[] dArr7 = dArr;
                                    dArr2[i32] = dArr7[i33];
                                    dArr2[i34] = dArr7[i33 + 1];
                                    dArr2[DoubleDST_3D.this.slices + i34] = dArr[i33 + 2];
                                    dArr2[i34 + (DoubleDST_3D.this.slices * 2)] = dArr[i33 + 3];
                                }
                                DoubleDST_3D.this.dstSlices.inverse(dArr2, 0, z);
                                DoubleDST_3D.this.dstSlices.inverse(dArr2, DoubleDST_3D.this.slices, z);
                                ...
                                for (int i35 = 0; i35 < DoubleDST_3D.this.slices; i35++) {
                                    int i36 = (DoubleDST_3D.this.sliceStride * i35) + i30 + i31;
                                    int i37 = DoubleDST_3D.this.slices + i35;
                                    double[] dArr8 = dArr;
                                    dArr8[i36] = dArr2[i35];
                                    dArr8[i36 + 1] = dArr2[i37];
                                    dArr8[i36 + 2] = dArr2[DoubleDST_3D.this.slices + i37];
                                    dArr[i36 + 3] = dArr2[i37 + (DoubleDST_3D.this.slices * 2)];
                                }
                            }
                            i29 += i3;
                        }
    ...
    private void ddxt3db_subth(final int i, final DoubleLargeArray doubleLargeArray, final boolean z) {
        ...
        while (i3 < i2) {
            final long j4 = i3;
            int i4 = i3;
            futureArr[i4] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.23
                @Override // java.lang.Runnable
                public void run() {
                    DoubleLargeArray doubleLargeArray2 = new DoubleLargeArray(j3);
                    long j5 = 1;
                    if (i == -1) {
                        if (DoubleDST_3D.this.columnsl <= 2) {
                            if (DoubleDST_3D.this.columnsl == 2) {
                                long j6 = j4;
                                while (j6 < DoubleDST_3D.this.rowsl) {
                                    long j7 = DoubleDST_3D.this.rowStridel * j6;
                                    for (long j8 = 0; j8 < DoubleDST_3D.this.slicesl; j8++) {
                                        long j9 = (DoubleDST_3D.this.sliceStridel * j8) + j7;
                                        doubleLargeArray2.setDouble(j8, doubleLargeArray.getDouble(j9));
                                        doubleLargeArray2.setDouble(DoubleDST_3D.this.slicesl + j8, doubleLargeArray.getDouble(j9 + 1));
                                    }
                                    ...
                                    for (long j10 = 0; j10 < DoubleDST_3D.this.slicesl; j10++) {
                                        long j11 = (DoubleDST_3D.this.sliceStridel * j10) + j7;
                        ...
                        while (j12 < DoubleDST_3D.this.rowsl) {
                            ...
                            while (j14 < DoubleDST_3D.this.columnsl) {
                                ...
                                while (j15 < DoubleDST_3D.this.slicesl) {
                                    ...
                                    doubleLargeArray2.setDouble(DoubleDST_3D.this.slicesl + j17, doubleLargeArray.getDouble(j16 + 2));
                                ...
                                DoubleDST_3D.this.dstSlices.forward(doubleLargeArray2, 0L, z);
                                DoubleDST_3D.this.dstSlices.forward(doubleLargeArray2, DoubleDST_3D.this.slicesl, z);
                                DoubleDST_3D.this.dstSlices.forward(doubleLargeArray2, DoubleDST_3D.this.slicesl * 2, z);
                                DoubleDST_3D.this.dstSlices.forward(doubleLargeArray2, DoubleDST_3D.this.slicesl * 3, z);
                                for (long j19 = 0; j19 < DoubleDST_3D.this.slicesl; j19++) {
                                    long j20 = (DoubleDST_3D.this.sliceStridel * j19) + j13 + j14;
                                    long j21 = DoubleDST_3D.this.slicesl + j19;
                                    doubleLargeArray.setDouble(j20, doubleLargeArray2.getDouble(j19));
                                    doubleLargeArray.setDouble(j20 + 1, doubleLargeArray2.getDouble(j21));
                                    doubleLargeArray.setDouble(j20 + 2, doubleLargeArray2.getDouble(j21 + DoubleDST_3D.this.slicesl));
                                    doubleLargeArray.setDouble(j20 + 3, doubleLargeArray2.getDouble(j21 + (DoubleDST_3D.this.slicesl * 2)));
                                }
                                j14 += 4;
                                j12 = j18;
                                j5 = 1;
                        ...
                        if (DoubleDST_3D.this.columnsl == 2) {
                            long j22 = j4;
                            while (j22 < DoubleDST_3D.this.rowsl) {
                                long j23 = DoubleDST_3D.this.rowStridel * j22;
                                for (long j24 = 0; j24 < DoubleDST_3D.this.slicesl; j24++) {
                                    long j25 = (DoubleDST_3D.this.sliceStridel * j24) + j23;
                                    doubleLargeArray2.setDouble(j24, doubleLargeArray.getDouble(j25));
                                    doubleLargeArray2.setDouble(DoubleDST_3D.this.slicesl + j24, doubleLargeArray.getDouble(j25 + 1));
                                }
                                ...
                                for (long j26 = 0; j26 < DoubleDST_3D.this.slicesl; j26++) {
                                    long j27 = (DoubleDST_3D.this.sliceStridel * j26) + j23;
                                    doubleLargeArray.setDouble(j27, doubleLargeArray2.getDouble(j26));
                                    doubleLargeArray.setDouble(j27 + 1, doubleLargeArray2.getDouble(DoubleDST_3D.this.slicesl + j26));
                                }
                                j22 += i2;
                            }
                        }
                        ...
                        while (j28 < DoubleDST_3D.this.rowsl) {
                            long j29 = DoubleDST_3D.this.rowStridel * j28;
                            long j30 = 0;
                            while (j30 < DoubleDST_3D.this.columnsl) {
                                long j31 = 0;
                                while (j31 < DoubleDST_3D.this.slicesl) {
                                    long j32 = (DoubleDST_3D.this.sliceStridel * j31) + j29 + j30;
                                    long j33 = DoubleDST_3D.this.slicesl + j31;
                                    ...
                                    doubleLargeArray2.setDouble(DoubleDST_3D.this.slicesl + j33, doubleLargeArray.getDouble(j32 + 2));
                                    doubleLargeArray2.setDouble(j33 + (DoubleDST_3D.this.slicesl * 2), doubleLargeArray.getDouble(j32 + 3));
                                    j31++;
                                    j28 = j28;
                                    j30 = j30;
                                }
                                ...
                                for (long j36 = 0; j36 < DoubleDST_3D.this.slicesl; j36++) {
                                    long j37 = (DoubleDST_3D.this.sliceStridel * j36) + j29 + j35;
                                    long j38 = DoubleDST_3D.this.slicesl + j36;
                                    ...
                                    doubleLargeArray.setDouble(j37 + 2, doubleLargeArray2.getDouble(j38 + DoubleDST_3D.this.slicesl));
                                    doubleLargeArray.setDouble(j37 + 3, doubleLargeArray2.getDouble(j38 + (DoubleDST_3D.this.slicesl * 2)));
                                }
                                j30 = j35 + 4;
                                j28 = j34;
                            }
    ...
    private void ddxt3db_subth(final int i, final double[][][] dArr, final boolean z) {
        ...
        for (int i6 = 0; i6 < i3; i6++) {
            final int i7 = i6;
            futureArr[i6] = ConcurrencyUtils.submit(new Runnable() { // from class: org.jtransforms.dst.DoubleDST_3D.24
                @Override // java.lang.Runnable
                public void run() {
                    double[] dArr2 = new double[i5];
                    if (i == -1) {
                        if (DoubleDST_3D.this.columns <= 2) {
                            if (DoubleDST_3D.this.columns == 2) {
                                int i8 = i7;
                                while (i8 < DoubleDST_3D.this.rows) {
                                    for (int i9 = 0; i9 < DoubleDST_3D.this.slices; i9++) {
                                        dArr2[i9] = dArr[i9][i8][0];
                                        dArr2[DoubleDST_3D.this.slices + i9] = dArr[i9][i8][1];
                                    }
                                    DoubleDST_3D.this.dstSlices.forward(dArr2, 0, z);
                                    DoubleDST_3D.this.dstSlices.forward(dArr2, DoubleDST_3D.this.slices, z);
                                    for (int i10 = 0; i10 < DoubleDST_3D.this.slices; i10++) {
                                        ...
                                        dArr3[0] = dArr2[i10];
                                        dArr3[1] = dArr2[DoubleDST_3D.this.slices + i10];
                                    }
                                    i8 += i3;
                                }
                                return;
                        ...
                        int i11 = i7;
                        while (i11 < DoubleDST_3D.this.rows) {
                            for (int i12 = 0; i12 < DoubleDST_3D.this.columns; i12 += 4) {
                                for (int i13 = 0; i13 < DoubleDST_3D.this.slices; i13++) {
                                    ...
                                    dArr2[DoubleDST_3D.this.slices + i14] = dArr[i13][i11][i12 + 2];
                                    dArr2[i14 + (DoubleDST_3D.this.slices * 2)] = dArr[i13][i11][i12 + 3];
                                }
                                DoubleDST_3D.this.dstSlices.forward(dArr2, 0, z);
                                DoubleDST_3D.this.dstSlices.forward(dArr2, DoubleDST_3D.this.slices, z);
                                DoubleDST_3D.this.dstSlices.forward(dArr2, DoubleDST_3D.this.slices * 2, z);
                                ...
                                for (int i15 = 0; i15 < DoubleDST_3D.this.slices; i15++) {
                                    int i16 = DoubleDST_3D.this.slices + i15;
                                    double[] dArr5 = dArr[i15][i11];
                                    dArr5[i12] = dArr2[i15];
                                    dArr5[i12 + 1] = dArr2[i16];
                                    dArr5[i12 + 2] = dArr2[DoubleDST_3D.this.slices + i16];
                                    dArr[i15][i11][i12 + 3] = dArr2[i16 + (DoubleDST_3D.this.slices * 2)];
                                }
                            }
                            i11 += i3;
                        }
                        ...
                        if (DoubleDST_3D.this.columns == 2) {
                            int i17 = i7;
                            while (i17 < DoubleDST_3D.this.rows) {
                                for (int i18 = 0; i18 < DoubleDST_3D.this.slices; i18++) {
                                    dArr2[i18] = dArr[i18][i17][0];
                                    dArr2[DoubleDST_3D.this.slices + i18] = dArr[i18][i17][1];
                                }
                                DoubleDST_3D.this.dstSlices.inverse(dArr2, 0, z);
                                DoubleDST_3D.this.dstSlices.inverse(dArr2, DoubleDST_3D.this.slices, z);
                                for (int i19 = 0; i19 < DoubleDST_3D.this.slices; i19++) {
                                    double[] dArr6 = dArr[i19][i17];
                                    dArr6[0] = dArr2[i19];
                                    dArr6[1] = dArr2[DoubleDST_3D.this.slices + i19];
                                }
                                i17 += i3;
                            }
                        }
                        ...
                        int i20 = i7;
                        while (i20 < DoubleDST_3D.this.rows) {
                            for (int i21 = 0; i21 < DoubleDST_3D.this.columns; i21 += 4) {
                                for (int i22 = 0; i22 < DoubleDST_3D.this.slices; i22++) {
                                    ...
                                    dArr2[DoubleDST_3D.this.slices + i23] = dArr[i22][i20][i21 + 2];
                                    dArr2[i23 + (DoubleDST_3D.this.slices * 2)] = dArr[i22][i20][i21 + 3];
                                }
                                DoubleDST_3D.this.dstSlices.inverse(dArr2, 0, z);
                                DoubleDST_3D.this.dstSlices.inverse(dArr2, DoubleDST_3D.this.slices, z);
                                DoubleDST_3D.this.dstSlices.inverse(dArr2, DoubleDST_3D.this.slices * 2, z);
                                DoubleDST_3D.this.dstSlices.inverse(dArr2, DoubleDST_3D.this.slices * 3, z);
                                for (int i24 = 0; i24 < DoubleDST_3D.this.slices; i24++) {
                                    int i25 = DoubleDST_3D.this.slices + i24;
                                    double[] dArr8 = dArr[i24][i20];
                                    dArr8[i21] = dArr2[i24];
                                    dArr8[i21 + 1] = dArr2[i25];
                                    dArr8[i21 + 2] = dArr2[DoubleDST_3D.this.slices + i25];
                                    dArr[i24][i20][i21 + 3] = dArr2[i25 + (DoubleDST_3D.this.slices * 2)];
                                }
                            }
                            i20 += i3;
                        }
