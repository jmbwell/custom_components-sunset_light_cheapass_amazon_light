...
public final class FlowAdapters {
    ...
    public static <T> Flow.Publisher<T> toFlowPublisher(Publisher<? extends T> publisher) {
        ...
        if (Platform$$ExternalSyntheticApiModelOutline0.m$1(publisher)) {
            return Platform$$ExternalSyntheticApiModelOutline0.m2911m((Object) publisher);
        }
    ...
    public static <T, U> Flow.Processor<T, U> toFlowProcessor(Processor<? super T, ? extends U> processor) {
        ...
        if (Platform$$ExternalSyntheticApiModelOutline0.m$3(processor)) {
            return Platform$$ExternalSyntheticApiModelOutline0.m2910m((Object) processor);
        }
    ...
    public static <T> Flow.Subscriber<T> toFlowSubscriber(Subscriber<T> subscriber) {
        ...
        if (Platform$$ExternalSyntheticApiModelOutline0.m$2(subscriber)) {
            return Platform$$ExternalSyntheticApiModelOutline0.m2912m((Object) subscriber);
        }
