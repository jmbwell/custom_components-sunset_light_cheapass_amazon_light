...
public class WebViewRenderProcessImpl extends WebViewRenderProcess {
    ...
    public boolean terminate() {
        ...
        if (q.isSupportedByFramework()) {
            android.webkit.WebViewRenderProcess m430m = Constraints$Builder$$ExternalSyntheticApiModelOutline0.m430m((Object) this.mFrameworkObject.get());
            return m430m != null && ApiHelperForQ.terminate(m430m);
