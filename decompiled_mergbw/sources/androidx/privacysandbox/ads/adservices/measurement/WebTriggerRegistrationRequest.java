...
public final class WebTriggerRegistrationRequest {
    ...
    public final android.adservices.measurement.WebTriggerRegistrationRequest convertToAdServices$ads_adservices_release() {
        ...
        build = Trace$$ExternalSyntheticApiModelOutline0.m403m((List) WebTriggerParams.Companion.convertWebTriggerParams$ads_adservices_release(this.webTriggerParams), this.destination).build();
