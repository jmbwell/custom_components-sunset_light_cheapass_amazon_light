...
public final class WebSourceRegistrationRequest {
    ...
    public final android.adservices.measurement.WebSourceRegistrationRequest convertToAdServices$ads_adservices_release() {
        ...
        webDestination = Trace$$ExternalSyntheticApiModelOutline0.m((List) WebSourceParams.Companion.convertWebSourceParams$ads_adservices_release(this.webSourceParams), this.topOriginUri).setWebDestination(this.webDestination);
