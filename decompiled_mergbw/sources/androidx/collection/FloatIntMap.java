...
public abstract class FloatIntMap {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence prefix, CharSequence postfix, int i, CharSequence truncated, Function2<? super Float, ? super Integer, ? extends CharSequence> transform) {
