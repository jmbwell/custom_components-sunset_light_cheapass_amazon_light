...
public final class BindOnlySQLiteStatement implements SQLiteStatement {
    ...
    public void mo256bindBlob(int i, byte[] value) {
        ...
        this.$$delegate_0.mo256bindBlob(i, value);
    }
    ...
    public void mo257bindDouble(int i, double d) {
        this.$$delegate_0.mo257bindDouble(i, d);
    }
    ...
    public void mo258bindLong(int i, long j) {
        this.$$delegate_0.mo258bindLong(i, j);
    }

    @Override // androidx.sqlite.SQLiteStatement
    /* renamed from: bindNull */
    public void mo259bindNull(int i) {
        this.$$delegate_0.mo259bindNull(i);
    }
    ...
    public void mo260bindText(int i, String value) {
        Intrinsics.checkNotNullParameter(value, "value");
        this.$$delegate_0.mo260bindText(i, value);
    }

    @Override // androidx.sqlite.SQLiteStatement
    /* renamed from: clearBindings */
    public void mo261clearBindings() {
        this.$$delegate_0.mo261clearBindings();
    }
    ...
    /* compiled from: RoomRawQuery.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Landroidx/room/BindOnlySQLiteStatement$Companion;", "", "<init>", "()V", "ONLY_BIND_CALLS_ALLOWED_ERROR", "", "room-runtime_release"}, k = 1, mv = {2, 0, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
