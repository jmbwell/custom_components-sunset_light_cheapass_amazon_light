    ...
    */
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            ...
            StringBuilder sb = new StringBuilder(simpleName + VectorFormat.DEFAULT_PREFIX + Integer.toHexString(hashCode()) + " position=" + this.mPosition + " id=" + this.mItemId + ", oldPos=" + this.mOldPosition + ", pLpos:" + this.mPreLayoutPosition);
            if (isScrap()) {
                sb.append(" scrap ");
