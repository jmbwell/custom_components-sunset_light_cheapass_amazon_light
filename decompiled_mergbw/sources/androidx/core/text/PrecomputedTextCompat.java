...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                breakStrategy = ColorKt$$ExternalSyntheticApiModelOutline0.m84m(textPaint).setBreakStrategy(i);
    ...
    public PrecomputedText getPrecomputedText() {
        if (ColorKt$$ExternalSyntheticApiModelOutline0.m99m((Object) this.mText)) {
            return ColorKt$$ExternalSyntheticApiModelOutline0.m85m((Object) this.mText);
        }
        return null;
    }
