...
public final class Insets {
    ...
    public String toString() {
        return "Insets{left=" + this.left + ", top=" + this.f21top + ", right=" + this.right + ", bottom=" + this.bottom + AbstractJsonLexerKt.END_OBJ;
    }
    ...
    public android.graphics.Insets toPlatformInsets() {
        return Api29Impl.of(this.left, this.f21top, this.right, this.bottom);
    }
