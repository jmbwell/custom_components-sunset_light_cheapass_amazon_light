...
public class MotionWidget implements TypedValues {
    ...
    public String toString() {
        return this.mWidgetFrame.left + ", " + this.mWidgetFrame.f17top + ", " + this.mWidgetFrame.right + ", " + this.mWidgetFrame.bottom;
    }
    ...
    public int getTop() {
        return this.mWidgetFrame.f17top;
    }
    ...
    public int getHeight() {
        return this.mWidgetFrame.bottom - this.mWidgetFrame.f17top;
    }
