    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                String str3 = str2 + "[p: ";
                String str4 = (this.mPrevious[indexOf] != -1 ? str3 + this.mCache.mIndexedVariables[this.mVariables[this.mPrevious[indexOf]]] : str3 + SchedulerSupport.NONE) + ", n: ";
                str = (this.mNext[indexOf] != -1 ? str4 + this.mCache.mIndexedVariables[this.mVariables[this.mNext[indexOf]]] : str4 + SchedulerSupport.NONE) + "]";
            }
        }
        return str + " }";
    }
