...
public abstract class JavaSerializableSerializer<T extends Serializable> implements KSerializer<T> {
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        SavedStateWriter.m376putJavaSerializableimpl(SavedStateWriter.m356constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
    ...
    public final T deserialize(Decoder decoder) {
        ...
        T t = (T) SavedStateReader.m308getJavaSerializableimpl(SavedStateReader.m270constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Serializable.class));
