...
.method private final writeCanonicalized(Lokio/Buffer;Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)V
    ...
    invoke-static {v11, v12, v13, v14, v6}, Lkotlin/text/StringsKt;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    invoke-direct {p0, v2, v7, v3}, Lokhttp3/HttpUrl$Companion;->isPercentEncoded(Ljava/lang/String;II)Z
    ...
    invoke-virtual {v8, v2, v7, v11, v5}, Lokio/Buffer;->writeString(Ljava/lang/String;IILjava/nio/charset/Charset;)Lokio/Buffer;
    ...
    :cond_9
    :goto_3
    invoke-virtual {v8, v9}, Lokio/Buffer;->writeUtf8CodePoint(I)Lokio/Buffer;
    ...
    .line 1859
    invoke-virtual {v1, v10}, Lokio/Buffer;->writeByte(I)Lokio/Buffer;
