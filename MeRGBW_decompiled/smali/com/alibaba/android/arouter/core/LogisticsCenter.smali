...
.method public static declared-synchronized completion(Lcom/alibaba/android/arouter/facade/Postcard;)V
    ...
    const-string v0, "ARouter::Fatal exception when loading group meta. ["

    const-string v1, "ARouter::There is no route match the path ["

    const-class v2, Lcom/alibaba/android/arouter/core/LogisticsCenter;
    ...
    check-cast v3, Lcom/alibaba/android/arouter/facade/model/RouteMeta;
    ...
    .line 229
    sget-object v3, Lcom/alibaba/android/arouter/core/Warehouse;->groupsIndex:Ljava/util/Map;
    ...
    const-string v9, "The group [%s] starts loading, trigger by [%s]"
    ...
    invoke-interface {v1, v3, v8}, Lcom/alibaba/android/arouter/facade/template/ILogger;->debug(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v7}, Lcom/alibaba/android/arouter/core/LogisticsCenter;->addRouteGroupDynamic(Ljava/lang/String;Lcom/alibaba/android/arouter/facade/template/IRouteGroup;)V
    ...
    const-string v8, "The group [%s] has already been loaded, trigger by [%s]"
    ...
    invoke-interface {v1, v3, v4}, Lcom/alibaba/android/arouter/facade/template/ILogger;->debug(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    .line 250
    :cond_3
    invoke-virtual {v3}, Lcom/alibaba/android/arouter/facade/model/RouteMeta;->getDestination()Ljava/lang/Class;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/alibaba/android/arouter/facade/Postcard;->setDestination(Ljava/lang/Class;)Lcom/alibaba/android/arouter/facade/model/RouteMeta;

    .line 251
    invoke-virtual {v3}, Lcom/alibaba/android/arouter/facade/model/RouteMeta;->getType()Lcom/alibaba/android/arouter/facade/enums/RouteType;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/alibaba/android/arouter/facade/Postcard;->setType(Lcom/alibaba/android/arouter/facade/enums/RouteType;)Lcom/alibaba/android/arouter/facade/model/RouteMeta;

    .line 252
    invoke-virtual {v3}, Lcom/alibaba/android/arouter/facade/model/RouteMeta;->getPriority()I

    move-result v0

    invoke-virtual {p0, v0}, Lcom/alibaba/android/arouter/facade/Postcard;->setPriority(I)Lcom/alibaba/android/arouter/facade/model/RouteMeta;

    .line 253
    invoke-virtual {v3}, Lcom/alibaba/android/arouter/facade/model/RouteMeta;->getExtra()I

    move-result v0

    invoke-virtual {p0, v0}, Lcom/alibaba/android/arouter/facade/Postcard;->setExtra(I)Lcom/alibaba/android/arouter/facade/model/RouteMeta;
    ...
    .line 257
    invoke-static {v0}, Lcom/alibaba/android/arouter/utils/TextUtils;->splitQueryParameters(Landroid/net/Uri;)Ljava/util/Map;

    move-result-object v1

    .line 258
    invoke-virtual {v3}, Lcom/alibaba/android/arouter/facade/model/RouteMeta;->getParamsType()Ljava/util/Map;
    ...
    invoke-virtual {v1, v9, v4}, Landroid/os/Bundle;->putStringArray(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/alibaba/android/arouter/facade/Postcard;->withString(Ljava/lang/String;Ljava/lang/String;)Lcom/alibaba/android/arouter/facade/Postcard;
    ...
    invoke-interface {v1, v3}, Lcom/alibaba/android/arouter/facade/template/IProvider;->init(Landroid/content/Context;)V
    ...
    invoke-interface {v0, v1, v3, p0}, Lcom/alibaba/android/arouter/facade/template/ILogger;->error(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static declared-synchronized init(Landroid/content/Context;Ljava/util/concurrent/ThreadPoolExecutor;)V
    ...
    invoke-interface {p0, p1, v0}, Lcom/alibaba/android/arouter/facade/template/ILogger;->info(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p1, v5, v6}, Lcom/alibaba/android/arouter/facade/template/ILogger;->info(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "com.alibaba.android.arouter.routes"

    invoke-static {p1, v5}, Lcom/alibaba/android/arouter/utils/ClassUtils;->getFileNameByPackageName(Landroid/content/Context;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-interface {p0, v5, v0}, Lcom/alibaba/android/arouter/facade/template/ILogger;->info(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 173
    const-string v0, "com.alibaba.android.arouter.routes.ARouter$$Root"
    ...
    invoke-interface {p1, v0}, Lcom/alibaba/android/arouter/facade/template/IRouteRoot;->loadInto(Ljava/util/Map;)V

    goto :goto_2

    .line 176
    :cond_5
    const-string v0, "com.alibaba.android.arouter.routes.ARouter$$Interceptors"
    ...
    invoke-interface {p1, v0}, Lcom/alibaba/android/arouter/facade/template/IInterceptorGroup;->loadInto(Ljava/util/Map;)V

    goto :goto_2

    .line 179
    :cond_6
    const-string v0, "com.alibaba.android.arouter.routes.ARouter$$Providers"
    ...
    invoke-interface {p1, v0}, Lcom/alibaba/android/arouter/facade/template/IProviderGroup;->loadInto(Ljava/util/Map;)V
    ...
    invoke-interface {p0, p1, v0}, Lcom/alibaba/android/arouter/facade/template/ILogger;->error(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static register(Ljava/lang/String;)V
    ...
    .line 80
    instance-of v3, v2, Lcom/alibaba/android/arouter/facade/template/IRouteRoot;

    if-eqz v3, :cond_0

    .line 81
    check-cast v2, Lcom/alibaba/android/arouter/facade/template/IRouteRoot;

    invoke-static {v2}, Lcom/alibaba/android/arouter/core/LogisticsCenter;->registerRouteRoot(Lcom/alibaba/android/arouter/facade/template/IRouteRoot;)V

    goto :goto_0

    .line 82
    :cond_0
    instance-of v3, v2, Lcom/alibaba/android/arouter/facade/template/IProviderGroup;

    if-eqz v3, :cond_1

    .line 83
    check-cast v2, Lcom/alibaba/android/arouter/facade/template/IProviderGroup;

    invoke-static {v2}, Lcom/alibaba/android/arouter/core/LogisticsCenter;->registerProvider(Lcom/alibaba/android/arouter/facade/template/IProviderGroup;)V

    goto :goto_0

    .line 84
    :cond_1
    instance-of v3, v2, Lcom/alibaba/android/arouter/facade/template/IInterceptorGroup;

    if-eqz v3, :cond_2

    .line 85
    check-cast v2, Lcom/alibaba/android/arouter/facade/template/IInterceptorGroup;

    invoke-static {v2}, Lcom/alibaba/android/arouter/core/LogisticsCenter;->registerInterceptor(Lcom/alibaba/android/arouter/facade/template/IInterceptorGroup;)V
    ...
    invoke-interface {v2, v0, v1}, Lcom/alibaba/android/arouter/facade/template/ILogger;->info(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
