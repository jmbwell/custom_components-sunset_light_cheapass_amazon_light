...
public class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.TooltipCompatHandler$$ExternalSyntheticLambda0
        ...
        public final void run() {
            TooltipCompatHandler.this.m32lambda$new$0$androidxappcompatwidgetTooltipCompatHandler();
        }
    };
    ...
    public /* synthetic */ void m32lambda$new$0$androidxappcompatwidgetTooltipCompatHandler() {
        show(false);
    }
