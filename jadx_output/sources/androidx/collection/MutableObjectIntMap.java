...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
    ...
    public final void plusAssign(ObjectIntMap<K> objectIntMap) {
        Intrinsics.checkNotNullParameter(objectIntMap, TypedValues.TransitionType.S_FROM);
        putAll(objectIntMap);
    }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (((Boolean) function2.invoke(this.keys[i4], Integer.valueOf(this.values[i4]))).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
