...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    public final int getOrPut(float f, Function0<Integer> function0) {
    ...
    public final void plusAssign(FloatIntMap floatIntMap) {
        Intrinsics.checkNotNullParameter(floatIntMap, TypedValues.TransitionType.S_FROM);
        putAll(floatIntMap);
    }
    ...
    public final void removeIf(Function2<? super Float, ? super Integer, Boolean> function2) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (((Boolean) function2.invoke(Float.valueOf(this.keys[i4]), Integer.valueOf(this.values[i4]))).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
