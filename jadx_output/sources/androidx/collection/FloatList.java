...
public abstract class FloatList {
    ...
    public final boolean any(Function1<? super Float, Boolean> function1) {
        ...
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            if (((Boolean) function1.invoke(Float.valueOf(fArr[i2]))).booleanValue()) {
                return true;
            }
        }
        return false;
    ...
    public final int count(Function1<? super Float, Boolean> function1) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            if (((Boolean) function1.invoke(Float.valueOf(fArr[i3]))).booleanValue()) {
                i2++;
            }
        }
        return i2;
    ...
    public final <R> R fold(R r, Function2<? super R, ? super Float, ? extends R> function2) {
        Intrinsics.checkNotNullParameter(function2, "operation");
        float[] fArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            r = (R) function2.invoke(r, Float.valueOf(fArr[i2]));
        }
        return r;
    }

    public final <R> R foldIndexed(R r, Function3<? super Integer, ? super R, ? super Float, ? extends R> function3) {
        Intrinsics.checkNotNullParameter(function3, "operation");
        float[] fArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            R r2 = r;
            r = (R) function3.invoke(Integer.valueOf(i2), r2, Float.valueOf(fArr[i2]));
        }
        return r;
    }

    public final <R> R foldRight(R r, Function2<? super Float, ? super R, ? extends R> function2) {
        Intrinsics.checkNotNullParameter(function2, "operation");
        float[] fArr = this.content;
        int i = this._size;
        while (true) {
            ...
            r = (R) function2.invoke(Float.valueOf(fArr[i]), r);
        }
    }

    public final <R> R foldRightIndexed(R r, Function3<? super Integer, ? super Float, ? super R, ? extends R> function3) {
        Intrinsics.checkNotNullParameter(function3, "operation");
        float[] fArr = this.content;
        int i = this._size;
        while (true) {
            ...
            r = (R) function3.invoke(Integer.valueOf(i), Float.valueOf(fArr[i]), r);
        }
    }
