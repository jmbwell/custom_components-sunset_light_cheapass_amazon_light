...
public abstract class FloatFloatMap {
    ...
    public final float getOrElse(float f, Function0<Float> function0) {
    ...
    public final void forEach(Function2<? super Float, ? super Float, Unit> function2) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        function2.invoke(Float.valueOf(fArr[i4]), Float.valueOf(fArr2[i4]));
                    }
                    j >>= 8;
                }
                if (i2 != 8) {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, Function2<? super Float, ? super Float, ? extends CharSequence> function2) {
    ...
    public final boolean all(Function2<? super Float, ? super Float, Boolean> function2) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (!((Boolean) function2.invoke(Float.valueOf(fArr[i4]), Float.valueOf(fArr2[i4]))).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
    ...
    public final boolean any(Function2<? super Float, ? super Float, Boolean> function2) {
        Intrinsics.checkNotNullParameter(function2, "predicate");
        float[] fArr = this.keys;
        float[] fArr2 = this.values;
        long[] jArr = this.metadata;
    ...
    public final int count(Function2<? super Float, ? super Float, Boolean> function2) {
        Intrinsics.checkNotNullParameter(function2, "predicate");
        float[] fArr = this.keys;
        float[] fArr2 = this.values;
        long[] jArr = this.metadata;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (((Boolean) function2.invoke(Float.valueOf(fArr[i6]), Float.valueOf(fArr2[i6]))).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
