...
public final class MutableLongIntMap extends LongIntMap {
    ...
    public final void plusAssign(LongIntMap longIntMap) {
        Intrinsics.checkNotNullParameter(longIntMap, TypedValues.TransitionType.S_FROM);
        putAll(longIntMap);
    }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (((Boolean) function2.invoke(Long.valueOf(this.keys[i4]), Integer.valueOf(this.values[i4]))).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
