...
public final class MutableIntObjectMap<V> extends IntObjectMap<V> {
    ...
    public final void plusAssign(IntObjectMap<V> intObjectMap) {
        Intrinsics.checkNotNullParameter(intObjectMap, TypedValues.TransitionType.S_FROM);
        putAll(intObjectMap);
    }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (((Boolean) function2.invoke(Integer.valueOf(this.keys[i4]), this.values[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
