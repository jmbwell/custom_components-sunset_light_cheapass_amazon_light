            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = iArr[(i << 3) + i3];
                            if (((Boolean) function1.invoke(Integer.valueOf(i4))).booleanValue()) {
                                return i4;
                            }
                        }
                        j >>= 8;
    ...
    public final boolean all(Function1<? super Integer, Boolean> function1) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                int i2 = 8 - ((~(i - length)) >>> 31);
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128 && !((Boolean) function1.invoke(Integer.valueOf(iArr[(i << 3) + i3]))).booleanValue()) {
                        return false;
                    }
                    j >>= 8;
                }
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128 && ((Boolean) function1.invoke(Integer.valueOf(iArr[(i2 << 3) + i5]))).booleanValue()) {
                            i3++;
                        }
                        j >>= 8;
                    }
