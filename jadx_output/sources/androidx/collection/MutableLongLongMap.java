...
public final class MutableLongLongMap extends LongLongMap {
    ...
    public final long getOrPut(long j, Function0<Long> function0) {
    ...
    public final void plusAssign(LongLongMap longLongMap) {
        Intrinsics.checkNotNullParameter(longLongMap, TypedValues.TransitionType.S_FROM);
        putAll(longLongMap);
    }
    ...
    public final void removeIf(Function2<? super Long, ? super Long, Boolean> function2) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (((Boolean) function2.invoke(Long.valueOf(this.keys[i4]), Long.valueOf(this.values[i4]))).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
