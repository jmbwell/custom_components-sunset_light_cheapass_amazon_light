...
public abstract class FloatSet {
    ...
    public final boolean all(Function1<? super Float, Boolean> function1) {
        Intrinsics.checkNotNullParameter(function1, "predicate");
        float[] fArr = this.elements;
        long[] jArr = this.metadata;
        int length = jArr.length - 2;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                int i2 = 8 - ((~(i - length)) >>> 31);
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128 && !((Boolean) function1.invoke(Float.valueOf(fArr[(i << 3) + i3]))).booleanValue()) {
                        return false;
                    }
                    j >>= 8;
                }
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128 && ((Boolean) function1.invoke(Float.valueOf(fArr[(i2 << 3) + i5]))).booleanValue()) {
                            i3++;
                        }
                        j >>= 8;
                    }
