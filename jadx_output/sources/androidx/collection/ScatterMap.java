...
public abstract class ScatterMap<K, V> {
    ...
    public final V getOrElse(K k, Function0<? extends V> function0) {
        ...
        V v = get(k);
        return v == null ? (V) function0.invoke() : v;
    }
    ...
    public static /* synthetic */ String joinToString$default(ScatterMap scatterMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, Function2 function2, int i2, Object obj) {
        if (obj == null) {
            ...
            return scatterMap.joinToString(charSequence, charSequence5, charSequence6, i3, charSequence7, function22);
        }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (!((Boolean) function2.invoke(objArr[i4], objArr2[i4])).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (((Boolean) function2.invoke(objArr[i6], objArr2[i6])).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
