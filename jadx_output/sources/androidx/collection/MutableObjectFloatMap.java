...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final float getOrPut(K k, Function0<Float> function0) {
    ...
    public final void plusAssign(ObjectFloatMap<K> objectFloatMap) {
        Intrinsics.checkNotNullParameter(objectFloatMap, TypedValues.TransitionType.S_FROM);
    ...
    public final void removeIf(Function2<? super K, ? super Float, Boolean> function2) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (((Boolean) function2.invoke(this.keys[i4], Float.valueOf(this.values[i4]))).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
