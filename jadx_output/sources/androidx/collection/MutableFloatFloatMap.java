...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    public final void plusAssign(FloatFloatMap floatFloatMap) {
        Intrinsics.checkNotNullParameter(floatFloatMap, TypedValues.TransitionType.S_FROM);
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (((Boolean) function2.invoke(Float.valueOf(this.keys[i4]), Float.valueOf(this.values[i4]))).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
