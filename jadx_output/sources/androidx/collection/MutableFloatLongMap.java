...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    public final long getOrPut(float f, Function0<Long> function0) {
    ...
    public final void plusAssign(FloatLongMap floatLongMap) {
        Intrinsics.checkNotNullParameter(floatLongMap, TypedValues.TransitionType.S_FROM);
        putAll(floatLongMap);
    }
    ...
    public final void removeIf(Function2<? super Float, ? super Long, Boolean> function2) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (((Boolean) function2.invoke(Float.valueOf(this.keys[i4]), Long.valueOf(this.values[i4]))).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
