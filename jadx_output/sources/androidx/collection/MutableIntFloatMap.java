...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    public final void plusAssign(IntFloatMap intFloatMap) {
        Intrinsics.checkNotNullParameter(intFloatMap, TypedValues.TransitionType.S_FROM);
        putAll(intFloatMap);
    }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (((Boolean) function2.invoke(Integer.valueOf(this.keys[i4]), Float.valueOf(this.values[i4]))).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
