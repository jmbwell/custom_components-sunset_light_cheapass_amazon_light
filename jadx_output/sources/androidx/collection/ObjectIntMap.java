...
public abstract class ObjectIntMap<K> {
    ...
    public final int getOrElse(K k, Function0<Integer> function0) {
    ...
    public final void forEach(Function2<? super K, ? super Integer, Unit> function2) {
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, Function2<? super K, ? super Integer, ? extends CharSequence> function2) {
        Object[] objArr;
        Object[] objArr2;
    ...
    public final boolean all(Function2<? super K, ? super Integer, Boolean> function2) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (!((Boolean) function2.invoke(objArr[i4], Integer.valueOf(iArr[i4]))).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
    ...
    public final boolean any(Function2<? super K, ? super Integer, Boolean> function2) {
        Intrinsics.checkNotNullParameter(function2, "predicate");
        Object[] objArr = this.keys;
        int[] iArr = this.values;
        long[] jArr = this.metadata;
    ...
    public final int count(Function2<? super K, ? super Integer, Boolean> function2) {
        Intrinsics.checkNotNullParameter(function2, "predicate");
        Object[] objArr = this.keys;
        int[] iArr = this.values;
        long[] jArr = this.metadata;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (((Boolean) function2.invoke(objArr[i6], Integer.valueOf(iArr[i6]))).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
