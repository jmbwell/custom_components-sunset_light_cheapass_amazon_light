...
public abstract class LongList {
    ...
    public final long elementAtOrElse(int i, Function1<? super Integer, Long> function1) {
        ...
        if (i < 0 || i >= this._size) {
            return ((Number) function1.invoke(Integer.valueOf(i))).longValue();
        }
        return this.content[i];
    }
    ...
    public final <R> R fold(R r, Function2<? super R, ? super Long, ? extends R> function2) {
        Intrinsics.checkNotNullParameter(function2, "operation");
        long[] jArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            r = (R) function2.invoke(r, Long.valueOf(jArr[i2]));
        }
        return r;
    }

    public final <R> R foldIndexed(R r, Function3<? super Integer, ? super R, ? super Long, ? extends R> function3) {
        Intrinsics.checkNotNullParameter(function3, "operation");
        long[] jArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            R r2 = r;
            r = (R) function3.invoke(Integer.valueOf(i2), r2, Long.valueOf(jArr[i2]));
        }
        return r;
    }

    public final <R> R foldRight(R r, Function2<? super Long, ? super R, ? extends R> function2) {
        Intrinsics.checkNotNullParameter(function2, "operation");
        long[] jArr = this.content;
        int i = this._size;
        while (true) {
            ...
            r = (R) function2.invoke(Long.valueOf(jArr[i]), r);
        }
    }

    public final <R> R foldRightIndexed(R r, Function3<? super Integer, ? super Long, ? super R, ? extends R> function3) {
        Intrinsics.checkNotNullParameter(function3, "operation");
        long[] jArr = this.content;
        int i = this._size;
        while (true) {
            ...
            r = (R) function3.invoke(Integer.valueOf(i), Long.valueOf(jArr[i]), r);
        }
    }
