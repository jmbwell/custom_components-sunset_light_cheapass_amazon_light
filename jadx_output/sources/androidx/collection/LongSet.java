...
public abstract class LongSet {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            long j2 = jArr[(i << 3) + i3];
                            if (((Boolean) function1.invoke(Long.valueOf(j2))).booleanValue()) {
                                return j2;
                            }
                        }
                        j >>= 8;
    ...
    public final boolean all(Function1<? super Long, Boolean> function1) {
        Intrinsics.checkNotNullParameter(function1, "predicate");
        long[] jArr = this.elements;
        long[] jArr2 = this.metadata;
        int length = jArr2.length - 2;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                int i2 = 8 - ((~(i - length)) >>> 31);
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128 && !((Boolean) function1.invoke(Long.valueOf(jArr[(i << 3) + i3]))).booleanValue()) {
                        return false;
                    }
                    j >>= 8;
                }
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128 && ((Boolean) function1.invoke(Long.valueOf(jArr[(i2 << 3) + i5]))).booleanValue()) {
                            i3++;
                        }
                        j >>= 8;
                    }
