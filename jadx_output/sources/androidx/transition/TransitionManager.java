...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo470clone = transition.mo470clone();
        mo470clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo470clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo470clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo470clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo470clone = transition.mo470clone();
        sceneChangeSetup(viewGroup, mo470clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo470clone);
    }
