...
public class Motion implements TypedValues {
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        double[][] dArr = (double[][]) Array.newInstance(Double.TYPE, i3, this.mInterpolateVariables.length);
        ...
        while (true) {
            ...
            for (int i17 = 0; i17 < i3; i17++) {
                if (motionPathsArr[i17].hasCustomData(str8)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i3];
                        dArr4 = (double[][]) Array.newInstance(Double.TYPE, i3, motionPathsArr[i17].getCustomDataCount(str8));
                    }
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            double[][] dArr6 = (double[][]) Array.newInstance(Double.TYPE, i3, 2);
