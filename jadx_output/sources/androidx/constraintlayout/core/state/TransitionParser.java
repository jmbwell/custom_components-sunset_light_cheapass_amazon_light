                ...
                if (cLKey.getValue() instanceof CLArray) {
                    ...
                    if (size3 == size && size3 > 0) {
                        if (cLArray.get(0) instanceof CLNumber) {
                            int i10 = 0;
                            while (i10 < size) {
                                customVariableArr[i10][i9] = new CustomVariable(content, (int) TypedValues.Custom.TYPE_FLOAT, cLArray.get(i10).getFloat());
                                i10++;
                                cLObject3 = cLObject3;
                            }
                        } else {
                            ...
                            while (i11 < size) {
                                ...
                                if (parseColorString != -1) {
                                    i2 = size2;
                                    customVariableArr[i11][i9] = new CustomVariable(content, (int) TypedValues.Custom.TYPE_COLOR, (int) parseColorString);
                                } else {
                                    i2 = size2;
                                }
                                i11++;
                    ...
                    if (value instanceof CLNumber) {
                        ...
                        for (int i12 = 0; i12 < size; i12++) {
                            customVariableArr[i12][i9] = new CustomVariable(content, (int) TypedValues.Custom.TYPE_FLOAT, f2);
                        }
                    } else {
                        ...
                        if (parseColorString2 != -1) {
                            int i13 = 0;
                            while (i13 < size) {
                                customVariableArr[i13][i9] = new CustomVariable(content, (int) TypedValues.Custom.TYPE_COLOR, (int) parseColorString2);
                                i13++;
