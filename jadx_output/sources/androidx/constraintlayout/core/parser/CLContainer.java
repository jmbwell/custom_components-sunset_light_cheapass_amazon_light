...
public class CLContainer extends CLElement {
    ...
    @Override // androidx.constraintlayout.core.parser.CLElement
    /* renamed from: clone */
    public CLContainer mo67clone() {
        CLContainer cLContainer = (CLContainer) super.mo67clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement mo67clone = it.next().mo67clone();
            mo67clone.setContainer(cLContainer);
            arrayList.add(mo67clone);
        }
