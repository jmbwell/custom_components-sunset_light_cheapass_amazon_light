...
public class MotionController {
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i2 < i) {
            ...
            if (viewOscillator != null) {
                ...
                fArr[i3] = fArr[i3] + viewSpline.get(f8);
            }
            if (viewOscillator2 != null) {
                int i5 = i3 + 1;
                fArr[i5] = fArr[i5] + viewOscillator2.get(f8);
            } else if (viewSpline2 != null) {
                int i6 = i3 + 1;
                fArr[i6] = fArr[i6] + viewSpline2.get(f8);
            }
            i2 = i4 + 1;
            f2 = 1.0f;
        }
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        double[][] dArr2 = (double[][]) Array.newInstance(Double.TYPE, i3, this.mInterpolateVariables.length);
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            double[][] dArr7 = (double[][]) Array.newInstance(Double.TYPE, i3, 2);
