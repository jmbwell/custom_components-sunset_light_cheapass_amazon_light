...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m146m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m146m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m146m = HalfKt$$ExternalSyntheticApiModelOutline0.m147m(windowInsets);
            } else {
                m146m = HalfKt$$ExternalSyntheticApiModelOutline0.m146m();
            }
            this.mPlatBuilder = m146m;
        }
