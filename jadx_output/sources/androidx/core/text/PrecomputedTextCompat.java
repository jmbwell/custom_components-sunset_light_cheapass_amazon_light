...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                breakStrategy = ColorKt$$ExternalSyntheticApiModelOutline0.m92m(textPaint).setBreakStrategy(i);
    ...
    public PrecomputedText getPrecomputedText() {
        if (ColorKt$$ExternalSyntheticApiModelOutline0.m107m((Object) this.mText)) {
            return ColorKt$$ExternalSyntheticApiModelOutline0.m93m((Object) this.mText);
        }
        return null;
    }
