...
public class ContentLoadingProgressBar extends ProgressBar {
    ...
    public /* synthetic */ void m173lambda$new$0$androidxcorewidgetContentLoadingProgressBar() {
    ...
    public /* synthetic */ void m174lambda$new$1$androidxcorewidgetContentLoadingProgressBar() {
    ...
    public ContentLoadingProgressBar(Context context, AttributeSet attributeSet) {
        ...
        this.mDelayedHide = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ContentLoadingProgressBar.this.m173lambda$new$0$androidxcorewidgetContentLoadingProgressBar();
            }
        };
        this.mDelayedShow = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                ContentLoadingProgressBar.this.m174lambda$new$1$androidxcorewidgetContentLoadingProgressBar();
            }
        };
    }
