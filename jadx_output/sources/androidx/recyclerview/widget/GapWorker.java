...
public final class GapWorker implements Runnable {
    ...
    private void flushTaskWithDeadline(Task task, long j) {
        RecyclerView.ViewHolder prefetchPositionWithDeadline = prefetchPositionWithDeadline(task.view, task.position, task.neededNextFrame ? LocationRequestCompat.PASSIVE_INTERVAL : j);
