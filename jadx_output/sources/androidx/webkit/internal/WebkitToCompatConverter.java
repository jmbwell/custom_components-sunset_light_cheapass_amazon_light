...
public class WebkitToCompatConverter {
    ...
    public ServiceWorkerWebSettings convertServiceWorkerSettings(InvocationHandler invocationHandler) {
        return Constraints$Builder$$ExternalSyntheticApiModelOutline0.m472m(this.mImpl.convertServiceWorkerSettings(invocationHandler));
    }
    ...
    public SafeBrowsingResponse convertSafeBrowsingResponse(InvocationHandler invocationHandler) {
        return Constraints$Builder$$ExternalSyntheticApiModelOutline0.m471m(this.mImpl.convertSafeBrowsingResponse(invocationHandler));
    }
