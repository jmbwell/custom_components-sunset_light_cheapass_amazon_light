...
public class WebViewRenderProcessImpl extends WebViewRenderProcess {
    ...
    public boolean terminate() {
        ...
        if (q.isSupportedByFramework()) {
            android.webkit.WebViewRenderProcess m473m = Constraints$Builder$$ExternalSyntheticApiModelOutline0.m473m((Object) this.mFrameworkObject.get());
            return m473m != null && ApiHelperForQ.terminate(m473m);
