...
public interface AutoMigrationSpec {
    ...
    public final /* synthetic */ class CC {
        public static void $default$onPostMigrate(AutoMigrationSpec _this, SQLiteConnection sQLiteConnection) {
            Intrinsics.checkNotNullParameter(sQLiteConnection, "connection");
            if (sQLiteConnection instanceof SupportSQLiteConnection) {
                _this.onPostMigrate(((SupportSQLiteConnection) sQLiteConnection).getDb());
            }
        }
    }
}
