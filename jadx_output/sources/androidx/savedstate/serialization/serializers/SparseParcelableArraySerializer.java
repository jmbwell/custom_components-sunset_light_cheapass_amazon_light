...
public final class SparseParcelableArraySerializer implements KSerializer<SparseArray<Parcelable>> {
    ...
    public void serialize(Encoder encoder, SparseArray<Parcelable> sparseArray) {
        ...
        SavedStateWriter.m416putSparseParcelableArrayimpl(SavedStateWriter.m384constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), sparseArray);
    }

    /* renamed from: deserialize */
    public SparseArray<Parcelable> m439deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m366getSparseParcelableArrayimpl(SavedStateReader.m298constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
