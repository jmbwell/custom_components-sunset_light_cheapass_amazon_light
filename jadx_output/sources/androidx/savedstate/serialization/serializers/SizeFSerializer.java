...
public final class SizeFSerializer implements KSerializer<SizeF> {
    ...
    public void serialize(Encoder encoder, SizeF sizeF) {
        ...
        SavedStateWriter.m415putSizeFimpl(SavedStateWriter.m384constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), sizeF);
    }

    /* renamed from: deserialize */
    public SizeF m435deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m362getSizeFimpl(SavedStateReader.m298constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
}
