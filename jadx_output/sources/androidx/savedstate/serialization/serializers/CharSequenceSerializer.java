...
public final class CharSequenceSerializer implements KSerializer<CharSequence> {
    ...
    public void serialize(Encoder encoder, CharSequence charSequence) {
        ...
        SavedStateWriter.m394putCharSequenceimpl(SavedStateWriter.m384constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), charSequence);
    }

    /* renamed from: deserialize */
    public CharSequence m427deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m315getCharSequenceimpl(SavedStateReader.m298constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
}
