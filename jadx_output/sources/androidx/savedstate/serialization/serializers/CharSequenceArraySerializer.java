...
public final class CharSequenceArraySerializer implements KSerializer<CharSequence[]> {
    ...
    public void serialize(Encoder encoder, CharSequence[] charSequenceArr) {
        ...
        SavedStateWriter.m395putCharSequenceArrayimpl(SavedStateWriter.m384constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), charSequenceArr);
    }
    ...
    public CharSequence[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m316getCharSequenceArrayimpl(SavedStateReader.m298constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
}
