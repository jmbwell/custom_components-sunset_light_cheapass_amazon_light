...
public final class ParcelableListSerializer implements KSerializer<List<? extends Parcelable>> {
    ...
    public void serialize(Encoder encoder, List<? extends Parcelable> list) {
        ...
        SavedStateWriter.m410putParcelableListimpl(SavedStateWriter.m384constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), list);
    }
    ...
    public List<Parcelable> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m350getParcelableListimpl(SavedStateReader.m298constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
