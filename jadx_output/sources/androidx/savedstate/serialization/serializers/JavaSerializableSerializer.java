...
public abstract class JavaSerializableSerializer<T extends Serializable> implements KSerializer<T> {
    ...
    public final void serialize(Encoder encoder, T t) {
        ...
        SavedStateWriter.m404putJavaSerializableimpl(SavedStateWriter.m384constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), t);
    }

    /* renamed from: deserialize */
    public final T m429deserialize(Decoder decoder) {
        ...
        T t = (T) SavedStateReader.m336getJavaSerializableimpl(SavedStateReader.m298constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Serializable.class));
