...
public abstract class ParcelableSerializer<T extends Parcelable> implements KSerializer<T> {
    ...
    public final void serialize(Encoder encoder, T t) {
        ...
        SavedStateWriter.m408putParcelableimpl(SavedStateWriter.m384constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), t);
    }

    /* renamed from: deserialize */
    public final T m433deserialize(Decoder decoder) {
        ...
        T t = (T) SavedStateReader.m344getParcelableimpl(SavedStateReader.m298constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Parcelable.class));
