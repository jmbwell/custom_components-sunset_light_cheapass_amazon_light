...
public final class ParcelableArraySerializer implements KSerializer<Parcelable[]> {
    ...
    public void serialize(Encoder encoder, Parcelable[] parcelableArr) {
        ...
        SavedStateWriter.m409putParcelableArrayimpl(SavedStateWriter.m384constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), parcelableArr);
    }
    ...
    public Parcelable[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m346getParcelableArrayimpl(SavedStateReader.m298constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
