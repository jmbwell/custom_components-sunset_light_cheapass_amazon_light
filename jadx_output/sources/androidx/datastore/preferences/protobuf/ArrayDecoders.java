...
public final class ArrayDecoders {
    ...
    public static int decodeVarint32(int firstByte, byte[] data, int position, Registers registers) {
        ...
        int i5 = i3 | ((b3 & Byte.MAX_VALUE) << 14);
        int i6 = position + 3;
        byte b4 = data[i4];
        if (b4 >= 0) {
            registers.int1 = i5 | (b4 << 21);
            return i6;
        }
        int i7 = i5 | ((b4 & Byte.MAX_VALUE) << 21);
        int i8 = position + 4;
        byte b5 = data[i6];
        if (b5 >= 0) {
            registers.int1 = i7 | (b5 << 28);
            return i8;
        }
    ...
    static int decodeVarint64(long firstByte, byte[] data, int position, Registers registers) {
        int i = position + 1;
        byte b2 = data[position];
        long j = (firstByte & 127) | ((b2 & Byte.MAX_VALUE) << 7);
        int i2 = 7;
        while (b2 < 0) {
            int i3 = i + 1;
            byte b3 = data[i];
            i2 += 7;
            j |= (b3 & Byte.MAX_VALUE) << i2;
            i = i3;
            b2 = b3;
        }
        registers.long1 = j;
