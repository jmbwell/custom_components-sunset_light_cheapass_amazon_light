...
public final class SharedCounter {
    ...
    public static final class Factory {
        ...
        public final SharedCounter create$datastore_core_release(Function0<? extends File> function0) {
            ParcelFileDescriptor parcelFileDescriptor;
            Intrinsics.checkNotNullParameter(function0, "produceFile");
            try {
                parcelFileDescriptor = ParcelFileDescriptor.open((File) function0.invoke(), 939524096);
                try {
