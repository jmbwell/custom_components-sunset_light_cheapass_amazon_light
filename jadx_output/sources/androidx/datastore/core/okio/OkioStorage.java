...
public final class OkioStorage<T> implements Storage<T> {
    ...
    public OkioStorage(FileSystem fileSystem, OkioSerializer<T> okioSerializer, Function2<? super Path, ? super FileSystem, ? extends InterProcessCoordinator> function2, Function0<Path> function0) {
    ...
    public StorageConnection<T> createConnection() {
        ...
        return new OkioStorageConnection(this.fileSystem, getCanonicalPath(), this.serializer, (InterProcessCoordinator) this.coordinatorProducer.invoke(getCanonicalPath(), this.fileSystem), new Function0<Unit>(this) { // from class: androidx.datastore.core.okio.OkioStorage$createConnection$2
            final /* synthetic */ OkioStorage<T> this$0;
            ...
            public final void m184invoke() {
                Path canonicalPath;
                Synchronizer activeFilesLock2 = OkioStorage.Companion.getActiveFilesLock();
                OkioStorage<T> okioStorage = this.this$0;
