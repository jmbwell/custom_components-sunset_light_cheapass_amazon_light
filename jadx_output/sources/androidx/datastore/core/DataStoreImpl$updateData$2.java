...
final class DataStoreImpl$updateData$2<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> dataStoreImpl$updateData$2 = new DataStoreImpl$updateData$2<>(this.this$0, this.$transform, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = CompletableDeferred$default.await((Continuation) this);
