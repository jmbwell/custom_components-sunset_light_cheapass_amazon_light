...
final class StorageConnectionKt$writeData$2<T> extends SuspendLambda implements Function2<WriteScope<T>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> storageConnectionKt$writeData$2 = new StorageConnectionKt$writeData$2<>(this.$value, continuation);
    ...
    public final Object invoke(WriteScope<T> writeScope, Continuation<? super Unit> continuation) {
        return create(writeScope, continuation).invokeSuspend(Unit.INSTANCE);
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return invoke((WriteScope) ((WriteScope) obj), (Continuation) obj2);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (((WriteScope) this.L$0).writeData(this.$value, (Continuation) this) == coroutine_suspended) {
