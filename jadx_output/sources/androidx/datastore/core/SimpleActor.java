...
public final class SimpleActor<T> {
    ...
    public final void offer(T t) {
        Object obj = this.messageQueue.trySend-JP2dKIU(t);
        ...
        } else if (!ChannelResult.isSuccess-impl(obj)) {
            throw new IllegalStateException("Check failed.".toString());
        } else {
            if (this.remainingMessages.getAndIncrement() == 0) {
                BuildersKt.launch$default(this.scope, (CoroutineContext) null, (CoroutineStart) null, new SimpleActor$offer$2(this, null), 3, (Object) null);
            }
        }
    }
}
