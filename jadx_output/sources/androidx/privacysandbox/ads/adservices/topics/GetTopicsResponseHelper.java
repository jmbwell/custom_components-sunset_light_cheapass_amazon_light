...
public final class GetTopicsResponseHelper {
    ...
    public final GetTopicsResponse convertResponse$ads_adservices_release(android.adservices.topics.GetTopicsResponse getTopicsResponse) {
        ...
        for (Object obj : topics) {
            android.adservices.topics.Topic m449m = Trace$$ExternalSyntheticApiModelOutline0.m449m(obj);
            taxonomyVersion = m449m.getTaxonomyVersion();
            modelVersion = m449m.getModelVersion();
            topicId = m449m.getTopicId();
