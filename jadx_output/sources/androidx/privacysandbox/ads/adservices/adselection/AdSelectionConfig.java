...
public final class AdSelectionConfig {
    ...
    public AdSelectionConfig(AdTechIdentifier adTechIdentifier, Uri uri, List<AdTechIdentifier> list, AdSelectionSignals adSelectionSignals, AdSelectionSignals adSelectionSignals2, Map<AdTechIdentifier, AdSelectionSignals> map, Uri uri2) {
        ...
        Intrinsics.checkNotNullParameter(adSelectionSignals2, "sellerSignals");
    ...
    public final android.adservices.adselection.AdSelectionConfig convertToAdServices$ads_adservices_release() {
        ...
        adSelectionSignals = Utf8Old$$ExternalSyntheticApiModelOutline0.m().setAdSelectionSignals(this.adSelectionSignals.convertToAdServices$ads_adservices_release());
    ...
    static {
        ...
        EMPTY = new AdSelectionConfig(adTechIdentifier, uri, emptyList, adSelectionSignals, adSelectionSignals2, emptyMap, uri2);
    }
}
