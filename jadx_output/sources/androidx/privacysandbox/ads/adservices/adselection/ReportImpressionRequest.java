    ...
    private static final class Ext10Impl {
        ...
        public static final class Companion {
            ...
            public final android.adservices.adselection.ReportImpressionRequest convertReportImpressionRequest(ReportImpressionRequest reportImpressionRequest) {
                Intrinsics.checkNotNullParameter(reportImpressionRequest, "request");
                if (Intrinsics.areEqual(reportImpressionRequest.getAdSelectionConfig(), AdSelectionConfig.Companion.getEMPTY())) {
                    AdFilters$$ExternalSyntheticApiModelOutline0.m259m$1();
                    return AdFilters$$ExternalSyntheticApiModelOutline0.m(reportImpressionRequest.getAdSelectionId());
                }
                AdFilters$$ExternalSyntheticApiModelOutline0.m259m$1();
                return AdFilters$$ExternalSyntheticApiModelOutline0.m(reportImpressionRequest.getAdSelectionId(), reportImpressionRequest.getAdSelectionConfig().convertToAdServices$ads_adservices_release());
            }
        }
    }
