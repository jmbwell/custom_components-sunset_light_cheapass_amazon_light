...
public class ProtectedSignalsManagerImpl extends ProtectedSignalsManager {
    ...
    public final android.adservices.signals.UpdateSignalsRequest convertUpdateRequest(UpdateSignalsRequest updateSignalsRequest) {
        ...
        build = Trace$$ExternalSyntheticApiModelOutline0.m447m(updateSignalsRequest.getUpdateUri()).build();
    ...
    static /* synthetic */ Object updateSignals$suspendImpl(ProtectedSignalsManagerImpl protectedSignalsManagerImpl, UpdateSignalsRequest updateSignalsRequest, Continuation<? super Unit> continuation) {
        ...
        protectedSignalsManagerImpl.protectedSignalsManager.updateSignals(protectedSignalsManagerImpl.convertUpdateRequest(updateSignalsRequest), new AdIdManagerImplCommon$$ExternalSyntheticLambda4(), OutcomeReceiverKt.asOutcomeReceiver((CancellableContinuation) cancellableContinuationImpl));
