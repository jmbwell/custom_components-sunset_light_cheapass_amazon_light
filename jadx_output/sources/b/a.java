...
public class a extends BluetoothGattCallback {
    ...
    public void onCharacteristicChanged(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        ...
        if (uuid.equals("5833ff03-9b8b-5191-6142-22a4536ef123")) {
            ...
            if ("0087".equals(this.j)) {
                ...
                this.e = i;
                this.f = 0;
                if (i < ((a.c) this.f10b.c().get(this.d)).b().size()) {
                    List list = (List) ((a.c) this.f10b.c().get(this.d)).b().get(this.e);
                    this.h = list;
                ...
                if (i2 < this.f10b.c().size()) {
                    ...
                    a(bluetoothGatt, this.f10b, this.d, this.g);
                }
            } else if ("0083".equals(this.j)) {
                a.b bVar2 = this.f11c;
                if (bVar2 != a.b.OTA && bVar2 != a.b.Security) {
                    if (bVar2 == a.b.RESOURCE) {
                        this.f9a.onResourceFinish();
                        return;
                    }
                    return;
                }
                this.f9a.onOTAFinish();
        ...
        if (bluetoothGattCharacteristic.getUuid().toString().equals("5833ff02-9b8b-5191-6142-22a4536ef123")) {
            ...
            if (i == 0) {
                ...
                if (this.q != this.d || this.r != this.e) {
                    ...
                    this.l = length;
                    this.f9a.onProcess((length * 100.0f) / this.k);
                }
                int i2 = this.f + 1;
                this.f = i2;
                if (i2 < this.h.size()) {
            ...
            b(bluetoothGatt, PointerIconCompat.TYPE_WAIT);
        }
    }
    ...
    public void onPhyUpdate(BluetoothGatt bluetoothGatt, int i, int i2, int i3) {
        this.f9a.a(bluetoothGatt, i, i2, i3);
    }
    ...
    private void a(BluetoothGatt bluetoothGatt, String str) {
        ...
        this.f9a.onError(PointerIconCompat.TYPE_HAND);
    }
    ...
    private void a(BluetoothGatt bluetoothGatt, a.a aVar, int i, long j) {
        ...
        this.f9a.onError(PointerIconCompat.TYPE_HELP);
    }
